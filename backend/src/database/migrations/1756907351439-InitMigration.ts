...
export class InitMigration1756907351439 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_d488a84526d22ad2b799829b7d" ON "tenants" ("subdomain") WHERE deleted_at IS NULL`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."loads_status_enum" AS ENUM('DRAFT', 'CREATED', 'PUBLISHED', 'ASSIGNED', 'IN_TRANSIT', 'DELIVERED', 'CANCELLED', 'COMPLETED')`);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_e7bddc41671772b45a3d803db9" ON "auction_watches" ("auctionId", "watcherId") `);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_a81d93c5706529dad43990e4a3" ON "auction_views" ("auctionId", "viewerId") `);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_019a1bfe83abbfab615a3c3ef9" ON "users" ("tenantId", "email") WHERE deleted_at IS NULL`);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_0ab497cdb0d3e2da3b58f5f704" ON "trucks" ("tenantId", "plateNumber") WHERE deleted_at IS NULL`);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_baea09a6daa36c25bc1f321699" ON "drivers" ("licenseNumber") WHERE deleted_at IS NULL`);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_47c934ba14c7f8893184544f86" ON "trips" ("tripNumber") `);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_6d53c760355b9723023759f004" ON "routes" ("tenantId", "name") WHERE deleted_at IS NULL`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."notifications_type_enum" AS ENUM('trip_update', 'payment_received', 'payment_failed', 'load_assigned', 'load_completed', 'driver_assigned', 'truck_maintenance', 'system_alert', 'matching_result', 'location_update', 'payment_refund', 'trip_cancelled', 'driver_available', 'truck_available')`);
        await queryRunner.query(`CREATE TYPE "public"."notifications_priority_enum" AS ENUM('low', 'normal', 'high', 'urgent')`);
        await queryRunner.query(`CREATE TYPE "public"."notifications_category_enum" AS ENUM('trip_status', 'payment', 'system', 'general', 'safety', 'performance', 'maintenance', 'security', 'marketing')`);
        await queryRunner.query(`CREATE TYPE "public"."notifications_deliverystatus_enum" AS ENUM('pending', 'sent', 'delivered', 'failed', 'bounced')`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_e3e90d958270f67459f0663d52" ON "notifications" ("deliveryStatus", "scheduledAt") `);
        await queryRunner.query(`CREATE INDEX "IDX_ca2808ef437730b9653f4b321f" ON "notifications" ("type", "priority", "createdAt") `);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_5f2d8564e7eb4d695c07237695" ON "loan_requests" ("idempotency_key") `);
        await queryRunner.query(`CREATE INDEX "IDX_8ee7b30ea492666d64145dea44" ON "loan_requests" ("lender_id", "created_at") `);
        await queryRunner.query(`CREATE INDEX "IDX_c7f21866f910eb39330b9ae245" ON "loan_requests" ("tenant_id", "status") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_995a06a8d5a68474ca56cc6921" ON "loan_repayments" ("loan_request_id", "repayment_date") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_ecdbc56578c2f5de4fd7d24644" ON "loan_disbursements" ("disbursement_date", "priority") `);
        await queryRunner.query(`CREATE INDEX "IDX_080a9cf92edbaecc889252fe4f" ON "loan_disbursements" ("loan_request_id", "status") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_dfdd03a38c678c1cd413a51611" ON "lenders" ("status", "created_at") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_a7e3658732378980e80c10b3aa" ON "lender_permissions" ("category", "level") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_b44909fa1fe38acfc3cf35b3dd" ON "lender_roles" ("level", "is_custom") `);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_a3d8ef2c048340ec8452f92646" ON "lender_users" ("email") `);
        await queryRunner.query(`CREATE INDEX "IDX_73ef64a4e0a6f298e63ad8e804" ON "lender_users" ("lender_id", "status") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_f684fad7dfb0f0baffd6ea99b3" ON "lender_policies" ("lender_id", "created_at") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_66a4fdd8f06d536dc5ef659e8f" ON "trip_locations" ("latitude", "longitude") `);
        await queryRunner.query(`CREATE INDEX "IDX_74f23daf6f2604f0adabfcac58" ON "trip_locations" ("driverId", "timestamp") `);
        await queryRunner.query(`CREATE INDEX "IDX_78ec5cd2f445dee8ae15338ba5" ON "trip_locations" ("tripId", "timestamp") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_bd901edc39205134d03cb76535" ON "trip_events" ("type", "severity") `);
        await queryRunner.query(`CREATE INDEX "IDX_3589adc3f99b4733fba9b3b311" ON "trip_events" ("driverId", "createdAt") `);
        await queryRunner.query(`CREATE INDEX "IDX_3267692da4aac579792dabc4a2" ON "trip_events" ("tripId", "type") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_41f05d0ab196734c957a5f94c5" ON "geofences" ("latitude", "longitude") `);
        await queryRunner.query(`CREATE INDEX "IDX_5bb1f8300c1aa9af9f2773237c" ON "geofences" ("type", "isActive") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_9fb62928ec18d06acd906abe59" ON "driver_alerts" ("createdAt") `);
        await queryRunner.query(`CREATE INDEX "IDX_876df290ec8bb81ffa45901b5a" ON "driver_alerts" ("type", "severity") `);
        await queryRunner.query(`CREATE INDEX "IDX_8f0b90cfcb9a320d316c792f60" ON "driver_alerts" ("tripId", "status") `);
        await queryRunner.query(`CREATE INDEX "IDX_2d1bc20ea70fb8d1fb8ea6eb51" ON "driver_alerts" ("driverId", "status") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_a5a95c2eb289dbb91ed5399bb9" ON "pricing_models" ("createdAt") `);
        await queryRunner.query(`CREATE INDEX "IDX_28a3a367424398db63e6cc68a5" ON "pricing_models" ("version", "status") `);
        await queryRunner.query(`CREATE INDEX "IDX_5d884262384edc276df2b0ef4b" ON "pricing_models" ("tenantId", "modelType") `);
        await queryRunner.query(`CREATE INDEX "IDX_17fe5d255209b618bc0f8c768d" ON "pricing_models" ("tenantId", "status") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_33d10083cddf802f824f537e86" ON "pricing_predictions" ("predictedAt") `);
        await queryRunner.query(`CREATE INDEX "IDX_812cb7cef1a3b868ec9aeb532a" ON "pricing_predictions" ("tripId") `);
        await queryRunner.query(`CREATE INDEX "IDX_f87cff4fc4d3a190d5ad231b4a" ON "pricing_predictions" ("modelId", "createdAt") `);
        await queryRunner.query(`CREATE INDEX "IDX_bfb0f932879521ce30397dd1be" ON "pricing_predictions" ("tenantId", "status") `);
        await queryRunner.query(`CREATE INDEX "IDX_7bf38a558895c578d35ea19a94" ON "pricing_predictions" ("tenantId", "modelId") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_be0cae5943aeb3a2aaa4344ef1" ON "pricing_features" ("isActive") `);
        await queryRunner.query(`CREATE INDEX "IDX_f39e8d6b34aaaf11c37d3f64bf" ON "pricing_features" ("featureName", "tenantId") `);
        await queryRunner.query(`CREATE INDEX "IDX_677b7a8c0a08cfa3c23c699d76" ON "pricing_features" ("tenantId", "featureSource") `);
        await queryRunner.query(`CREATE INDEX "IDX_8eedc2f59890953881e6176186" ON "pricing_features" ("tenantId", "featureType") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_4ec35888951e02b2898f54fd26" ON "notification_templates" ("isActive", "category") `);
        await queryRunner.query(`CREATE INDEX "IDX_e48756cbf41b42cb414abe1966" ON "notification_templates" ("tenantId", "language") `);
        await queryRunner.query(`CREATE INDEX "IDX_2191a1db3a22d1d2a8e055601d" ON "notification_templates" ("tenantId", "type") `);
        await queryRunner.query(`CREATE INDEX "IDX_a1b8057b12c7bf4e7e61856662" ON "notification_templates" ("tenantId", "category") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_05f0a14b055bab4011e9b58f09" ON "lender_role_permissions" ("role_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_f4803284da86c04ffbab09e0a1" ON "lender_role_permissions" ("permission_id") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_05f55bf74e2b5ba8b79b6f3b1c" ON "lender_user_permissions" ("user_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_3e247569401d14be97b1d99928" ON "lender_user_permissions" ("permission_id") `);
        ...
        await queryRunner.query(`ALTER TABLE "payments" DROP COLUMN "billingAddress"`);
        ...
        await queryRunner.query(`ALTER TABLE "payments" ADD "tripId" uuid NOT NULL`);
        await queryRunner.query(`ALTER TABLE "payments" ADD "payerId" uuid NOT NULL`);
        await queryRunner.query(`ALTER TABLE "payments" ADD "currency" character varying(3) NOT NULL`);
        // await queryRunner.query(`CREATE TYPE "public"."payments_paymenttype_enum" AS ENUM('trip_payment', 'subscription', 'service_fee', 'deposit', 'refund', 'withdrawal', 'advance', 'final')`);
        await queryRunner.query(`ALTER TABLE "payments" ADD "paymentType" "public"."payments_paymenttype_enum" NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "payments" ADD "gatewayResponse" character varying`);
        await queryRunner.query(`ALTER TABLE "payments" ADD "failureReason" character varying`);
        await queryRunner.query(`ALTER TABLE "payments" ADD "billingAddress" character varying`);
        await queryRunner.query(`ALTER TABLE "payments" ADD "dueDate" TIMESTAMP`);
        await queryRunner.query(`ALTER TABLE "payments" ADD "processedAt" TIMESTAMP`);
        await queryRunner.query(`ALTER TABLE "payments" ADD "metadata" jsonb NOT NULL DEFAULT '{}'`);
        await queryRunner.query(`ALTER TABLE "payments" ADD "deleted_at" TIMESTAMP`);
        await queryRunner.query(`ALTER TABLE "payments" ADD "invoiceId" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "payments" ADD "invoiceNumber" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "payments" ADD "customerId" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "payments" ADD "customerName" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "payments" ADD "paymentDate" TIMESTAMP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "payments" ADD "createdBy" uuid NOT NULL`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."payments_paymentmethod_enum" AS ENUM('check', 'ach', 'credit_card', 'wire', 'cash')`);
        ...
        await queryRunner.query(`ALTER TABLE "payments" ADD CONSTRAINT "FK_044f399afc445ec3094473acb93" FOREIGN KEY ("createdBy") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_23ce7ad7cd769295adf0fb7dd1"`);
        await queryRunner.query(`ALTER TABLE "payments" DROP COLUMN "notes"`);
        await queryRunner.query(`ALTER TABLE "payments" ADD "notes" character varying`);
        await queryRunner.query(`CREATE TYPE "public"."payments_status_enum_old" AS ENUM('pending', 'processing', 'completed', 'failed', 'cancelled', 'refunded', 'escrow')`);
        await queryRunner.query(`ALTER TABLE "payments" ALTER COLUMN "status" DROP DEFAULT`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."payments_paymentmethod_enum_old" AS ENUM('credit_card', 'debit_card', 'bank_transfer', 'digital_wallet', 'cash', 'check', 'wire_transfer')`);
        ...
        await queryRunner.query(`ALTER TABLE "payments" DROP COLUMN "invoiceNumber"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_f684fad7dfb0f0baffd6ea99b3"`);
        await queryRunner.query(`DROP TABLE "lender_policies"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_73ef64a4e0a6f298e63ad8e804"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_a3d8ef2c048340ec8452f92646"`);
        await queryRunner.query(`DROP TABLE "lender_users"`);
        await queryRunner.query(`DROP TYPE "public"."lender_users_status_enum"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_b44909fa1fe38acfc3cf35b3dd"`);
        await queryRunner.query(`DROP TABLE "lender_roles"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_a7e3658732378980e80c10b3aa"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_dfdd03a38c678c1cd413a51611"`);
        await queryRunner.query(`DROP TABLE "lenders"`);
        await queryRunner.query(`DROP TYPE "public"."lenders_status_enum"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_080a9cf92edbaecc889252fe4f"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_ecdbc56578c2f5de4fd7d24644"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_995a06a8d5a68474ca56cc6921"`);
        await queryRunner.query(`DROP TABLE "loan_repayments"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_c7f21866f910eb39330b9ae245"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_8ee7b30ea492666d64145dea44"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_5f2d8564e7eb4d695c07237695"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_ca2808ef437730b9653f4b321f"`);
