...
export function newDraftFromFacility(facility?: ParkingFacilityConfig | null, userId?: string): Partial<ParkingFeeSchedule> {
  return {
    parkingFacilityId: facility?.id,
    name: `${facility?.facilityName || 'Parking'} monthly`,
    description: '',
