...
export class CreateAllTables1762849950556 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP INDEX "public"."IDX_rate_limits_tenant_endpoint_createdAt"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_rate_limits_tenant_createdAt"`);
        
        await queryRunner.query(`CREATE EXTENSION IF NOT EXISTS "uuid-ossp"`);
        await queryRunner.query(`CREATE EXTENSION IF NOT EXISTS "postgis"`);

        await queryRunner.query(`CREATE TYPE "public"."user_profiles_kycstatus_enum" AS ENUM('PENDING', 'UNDER_REVIEW', 'VERIFIED', 'REJECTED')`);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX IF NOT EXISTS "IDX_8481388d6325e752cd4d7e26c6" ON "user_profiles" ("userId") `);
        await queryRunner.query(`CREATE TYPE "public"."tenants_type_enum" AS ENUM('ENTERPRISE', 'SMALL_BUSINESS', 'INDIVIDUAL', 'PARTNER')`);
        await queryRunner.query(`CREATE TYPE "public"."tenants_status_enum" AS ENUM('ACTIVE', 'SUSPENDED', 'PENDING_ACTIVATION', 'DEACTIVATED')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."auctions_auctiontype_enum" AS ENUM('REVERSE', 'FORWARD', 'DUTCH', 'SEALED')`);
        await queryRunner.query(`CREATE TYPE "public"."auctions_status_enum" AS ENUM('SCHEDULED', 'ACTIVE', 'CLOSED', 'CANCELLED', 'PAUSED')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."users_role_enum" AS ENUM('SUPER_ADMIN', 'ADMIN', 'TENANT_ADMIN', 'CARGO_OWNER', 'TRUCK_OWNER', 'DRIVER', 'AGENT', 'LENDER')`);
        await queryRunner.query(`CREATE TYPE "public"."users_status_enum" AS ENUM('PENDING_VERIFICATION', 'ACTIVE', 'SUSPENDED', 'DEACTIVATED')`);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX IF NOT EXISTS "IDX_019a1bfe83abbfab615a3c3ef9" ON "users" ("tenantId", "email") WHERE deleted_at IS NULL`);
        await queryRunner.query(`CREATE TYPE "public"."user_scores_category_enum" AS ENUM('financial_health', 'transaction_history', 'payment_behavior', 'cargo_quality', 'communication_score', 'reliability_score', 'overall_credit_score')`);
        await queryRunner.query(`CREATE TYPE "public"."user_scores_algorithm_enum" AS ENUM('financial_analysis', 'behavioral_pattern', 'risk_assessment', 'comprehensive')`);
        await queryRunner.query(`CREATE TABLE "user_scores" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "userId" character varying NOT NULL, "category" "public"."user_scores_category_enum" NOT NULL, "score" numeric(5,2) NOT NULL, "normalizedScore" numeric(5,2) NOT NULL, "algorithm" "public"."user_scores_algorithm_enum" NOT NULL, "factors" jsonb NOT NULL, "metadata" jsonb, "explanation" text, "isActive" boolean NOT NULL DEFAULT false, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_caf56c8fd1af4eeddd1aee555ae" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."user_ratings_ratingtype_enum" AS ENUM('transporter', 'financing_community', 'platform')`);
        await queryRunner.query(`CREATE TYPE "public"."user_ratings_category_enum" AS ENUM('reliability', 'payment_punctuality', 'communication', 'cargo_condition', 'professionalism', 'overall')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."user_rewards_type_enum" AS ENUM('transaction_bonus', 'volume_bonus', 'loyalty_points', 'cashback', 'discount', 'premium_features')`);
        await queryRunner.query(`CREATE TYPE "public"."user_rewards_status_enum" AS ENUM('pending', 'active', 'redeemed', 'expired')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."trucks_fueltype_enum" AS ENUM('DIESEL', 'GASOLINE', 'ELECTRIC', 'HYBRID', 'CNG', 'LNG')`);
        await queryRunner.query(`CREATE TYPE "public"."trucks_trucktype_enum" AS ENUM('FLATBED', 'BOX_TRUCK', 'TANKER', 'REFRIGERATED', 'CONTAINER', 'CAR_CARRIER', 'HEAVY_HAUL', 'LOWBED', 'STEP_DECK', 'POWER_ONLY', 'CURTAIN_SIDE', 'VAN', 'PLATFORM', 'BULK', 'DUMP', 'CEMENT_MIXER', 'CRANE', 'FIRE_TRUCK', 'AMBULANCE', 'TOW_TRUCK', 'GARBAGE', 'MILITARY', 'SPECIALIZED')`);
        await queryRunner.query(`CREATE TYPE "public"."trucks_trailertype_enum" AS ENUM('FLATBED', 'DRY_VAN', 'REFRIGERATED', 'TANKER', 'BULK', 'CONTAINER', 'CAR_CARRIER', 'HEAVY_HAUL', 'LOWBED', 'STEP_DECK', 'POWER_ONLY', 'CURTAIN_SIDE', 'PLATFORM', 'DUMP', 'CEMENT_MIXER', 'CRANE', 'SPECIALIZED')`);
        await queryRunner.query(`CREATE TYPE "public"."trucks_status_enum" AS ENUM('AVAILABLE', 'IN_TRANSIT', 'MAINTENANCE', 'OUT_OF_SERVICE')`);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX IF NOT EXISTS "IDX_0ab497cdb0d3e2da3b58f5f704" ON "trucks" ("tenantId", "plateNumber") WHERE deleted_at IS NULL`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."drivers_employmenttype_enum" AS ENUM('FULL_TIME', 'PART_TIME', 'CONTRACT', 'OWNER_OPERATOR', 'FREELANCE')`);
        await queryRunner.query(`CREATE TYPE "public"."drivers_status_enum" AS ENUM('ACTIVE', 'INACTIVE', 'SUSPENDED', 'ON_LEAVE', 'TERMINATED', 'IN_TRANSIT')`);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX IF NOT EXISTS "IDX_baea09a6daa36c25bc1f321699" ON "drivers" ("licenseNumber") WHERE deleted_at IS NULL`);
        await queryRunner.query(`CREATE TYPE "public"."trips_status_enum" AS ENUM('PLANNED', 'IN_PROGRESS', 'COMPLETED', 'CANCELLED', 'DELAYED')`);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX IF NOT EXISTS "IDX_47c934ba14c7f8893184544f86" ON "trips" ("tripNumber") `);
        await queryRunner.query(`CREATE TYPE "public"."tracking_events_type_enum" AS ENUM('Location', 'GeofenceEnter', 'GeofenceExit', 'Delay', 'Incident', 'StatusChange', 'DocumentUpload', 'Alert')`);
        await queryRunner.query(`CREATE TYPE "public"."tracking_events_geofencetype_enum" AS ENUM('pickup', 'delivery', 'custom', 'restricted')`);
        ...
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_a409b6270ed1bfc522ab31d898" ON "tracking_events" ("loadId") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_c6bd59f488e37653f66b02599f" ON "tracking_events" ("loadId", "timestamp") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_d62b1710396e4e118bdc877e5f" ON "tracking_events" ("timestamp") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_c8c82b37aeb9e8533d1d8cc47e" ON "tracking_events" ("type") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_a409b6270ed1bfc522ab31d898" ON "tracking_events" ("loadId") `);
        await queryRunner.query(`CREATE TABLE "route_trucks" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "tenantId" uuid NOT NULL, "routeId" uuid NOT NULL, "truckId" uuid NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_468d75203232a52d433c4eb12b0" UNIQUE ("tenantId", "routeId", "truckId"), CONSTRAINT "PK_eb8d8d94a28bcfe6d970802e578" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_941d32f73977001a50bf372375" ON "route_trucks" ("tenantId") `);
        await queryRunner.query(`CREATE TYPE "public"."routes_routetype_enum" AS ENUM('highway', 'city', 'rural', 'mixed')`);
        await queryRunner.query(`CREATE TYPE "public"."routes_status_enum" AS ENUM('active', 'inactive', 'maintenance')`);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX IF NOT EXISTS "IDX_6d53c760355b9723023759f004" ON "routes" ("tenantId", "name") WHERE deleted_at IS NULL`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."payments_status_enum" AS ENUM('pending', 'processing', 'completed', 'failed', 'cancelled', 'refunded', 'escrow')`);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX IF NOT EXISTS "IDX_ab673f0e63eac966762155508e" ON "password_reset_tokens" ("token") `);
        await queryRunner.query(`CREATE TYPE "public"."notifications_entitytype_enum" AS ENUM('USER', 'DRIVER', 'TRUCK', 'CARGO', 'TRIP', 'COMPANY', 'TENANT', 'SYSTEM', 'DOCUMENT', 'PAYMENT', 'EXPENSE')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."notifications_category_enum" AS ENUM('SYSTEM', 'USER', 'DRIVER', 'VEHICLE', 'CARGO', 'TRIP', 'TRIP_STATUS', 'FINANCIAL', 'COMPLIANCE', 'BUSINESS', 'EMERGENCY', 'GENERAL', 'SAFETY', 'PERFORMANCE', 'MAINTENANCE', 'MARKETING')`);
        await queryRunner.query(`CREATE TYPE "public"."notifications_priority_enum" AS ENUM('LOW', 'NORMAL', 'HIGH', 'URGENT', 'CRITICAL')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."insurance_claims_priority_enum" AS ENUM('low', 'medium', 'high', 'urgent')`);
        ...
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_cb231129fd839fedfd64b36b0b" ON "insurance_claims" ("incidentDate") `);
        ...
        await queryRunner.query(`CREATE TYPE "public"."insurance_policies_status_enum" AS ENUM('active', 'pending', 'expired', 'cancelled', 'suspended')`);
...
END$$;`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."insurance_renewals_status_enum" AS ENUM('pending', 'urgent', 'completed', 'expired', 'cancelled')`);
        await queryRunner.query(`CREATE TABLE "insurance_renewals" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "renewalNumber" character varying NOT NULL, "policyId" uuid NOT NULL, "truckId" uuid NOT NULL, "currentPolicyEndDate" date NOT NULL, "renewalDate" date NOT NULL, "status" "public"."insurance_renewals_status_enum" NOT NULL DEFAULT 'pending', "currentPremium" numeric(15,2) NOT NULL, "estimatedPremium" numeric(15,2), "finalPremium" numeric(15,2), "autoRenew" boolean NOT NULL DEFAULT false, "coverageChanges" json, "renewalTerms" json NOT NULL, "agent" json, "customerResponse" json, "documents" json, "reminders" json, "timeline" json, "notes" json, "riskAssessment" json, "competitorQuotes" json, "finalDecision" json, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_6e2b6bf8bb5605165c05fc9a719" UNIQUE ("renewalNumber"), CONSTRAINT "PK_f10727c57b6bff9ab8d6eefb0ac" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_6e2b6bf8bb5605165c05fc9a71" ON "insurance_renewals" ("renewalNumber") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_febfac3b7bf38da9b119fa050a" ON "insurance_renewals" ("policyId") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_4443a0125e443faf35976c0d07" ON "insurance_renewals" ("truckId") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_0768b1b477d6f9e590fc86aadd" ON "insurance_renewals" ("currentPolicyEndDate") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_842fba233d89f76938fdcb1cd0" ON "insurance_renewals" ("renewalDate") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_54c3d5907c87c8b44f4f962600" ON "insurance_renewals" ("status") `);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX IF NOT EXISTS "IDX_3d1613f95c6a564a3b588d161a" ON "email_verification_tokens" ("token") `);
        await queryRunner.query(`CREATE TYPE "public"."disputes_status_enum" AS ENUM('OPEN', 'RESOLVED', 'ESCALATED', 'REJECTED')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."documents_entitytype_enum" AS ENUM('USER', 'DRIVER', 'TRUCK', 'CARGO', 'TRIP', 'COMPANY', 'TENANT', 'SYSTEM')`);
        await queryRunner.query(`CREATE TYPE "public"."documents_documenttype_enum" AS ENUM('DRIVER_LICENSE', 'DRIVER_MEDICAL_CERT', 'DRIVER_DRUG_TEST', 'DRIVER_BACKGROUND_CHECK', 'DRIVER_TRAINING_CERT', 'DRIVER_INSURANCE', 'VEHICLE_REGISTRATION', 'VEHICLE_INSURANCE', 'VEHICLE_INSPECTION', 'VEHICLE_MAINTENANCE', 'VEHICLE_PERMIT', 'CARGO_MANIFEST', 'CARGO_INSURANCE', 'CARGO_CUSTOMS', 'CARGO_WEIGHT_CERT', 'BUSINESS_LICENSE', 'BUSINESS_INSURANCE', 'BUSINESS_TAX_CERT', 'BUSINESS_PERMIT', 'USER_ID_PROOF', 'USER_ADDRESS_PROOF', 'USER_BANK_DETAILS', 'TRIP_PERMIT', 'TRIP_ROUTE_PLAN', 'TRIP_WEIGHT_TICKET', 'POD', 'INVOICE', 'RECEIPT', 'PAYMENT_PROOF', 'EXPENSE_RECEIPT', 'SAFETY_CERT', 'ENVIRONMENTAL_CERT', 'QUALITY_CERT', 'CONTRACT', 'AGREEMENT', 'POLICY', 'MANUAL', 'OTHER')`);
        await queryRunner.query(`CREATE TYPE "public"."documents_category_enum" AS ENUM('IDENTITY', 'LICENSE', 'INSURANCE', 'CERTIFICATION', 'COMPLIANCE', 'FINANCIAL', 'OPERATIONAL', 'LEGAL', 'OTHER')`);
        await queryRunner.query(`CREATE TYPE "public"."documents_status_enum" AS ENUM('PENDING', 'VERIFIED', 'REJECTED', 'EXPIRED', 'ARCHIVED')`);
        await queryRunner.query(`CREATE TYPE "public"."documents_priority_enum" AS ENUM('LOW', 'NORMAL', 'HIGH', 'URGENT')`);
        ...
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_6010dc81933f1fdba08e89f76a" ON "documents" ("uploadedBy", "createdAt") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_4655f11878f993987b6c1c3f3d" ON "documents" ("expiryDate", "status") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_26cbb28d32120560be2b429b90" ON "documents" ("tenantId", "entityType") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_caecdab3f292c1620e81f8430d" ON "documents" ("category", "priority") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_cfc95e4fa2aa210b2ac4b359cd" ON "documents" ("documentType", "status") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_95476c2fe1b629671d3e6e7514" ON "documents" ("entityType", "entityId") `);
        await queryRunner.query(`CREATE TYPE "public"."audit_logs_action_enum" AS ENUM('CREATE', 'UPDATE', 'DELETE', 'LOGIN', 'LOGOUT', 'PAYMENT', 'DISPUTE', 'OTHER')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."audit_events_entitytype_enum" AS ENUM('load', 'document', 'tracking', 'alert', 'bid', 'trip')`);
        await queryRunner.query(`CREATE TYPE "public"."audit_events_action_enum" AS ENUM('create', 'update', 'delete', 'publish', 'assign', 'start', 'deliver', 'cancel', 'repost', 'status_change', 'document_upload', 'document_delete', 'location_update', 'pricing_update', 'alert_create', 'alert_update', 'tracking_update', 'bulk_operation')`);
        ...
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_fe948a2ef9575a943c46a916f5" ON "audit_events" ("loadId") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_9e76ea4cc84a0e407c5a3aeb05" ON "audit_events" ("actorId") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_3a68652a2168db305c9e592b84" ON "audit_events" ("loadId", "createdAt") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_7f51b93a1819ea59b9df7d9855" ON "audit_events" ("createdAt") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_9e76ea4cc84a0e407c5a3aeb05" ON "audit_events" ("actorId") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_68d908019304f757740bc47a0a" ON "audit_events" ("action") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_03dea5ad2fc208f12145bd5b99" ON "audit_events" ("entityType") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_fe948a2ef9575a943c46a916f5" ON "audit_events" ("loadId") `);
        await queryRunner.query(`CREATE TYPE "public"."alerts_type_enum" AS ENUM('Delay', 'RouteDeviation', 'Incident', 'TemperatureExcursion', 'CustomsHold', 'MechanicalIssue', 'WeatherDelay', 'TrafficDelay', 'SecurityIssue', 'Other')`);
        await queryRunner.query(`CREATE TYPE "public"."alerts_severity_enum" AS ENUM('Low', 'Medium', 'High', 'Critical')`);
        await queryRunner.query(`CREATE TYPE "public"."alerts_status_enum" AS ENUM('open', 'acknowledged', 'in_progress', 'resolved', 'closed')`);
        ...
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_143edd01c2f285d77e22f36a31" ON "alerts" ("loadId") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_8bb8f7c97396b99b57794c5999" ON "alerts" ("createdAt") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_619841f80de96e6b1f03ecc8e5" ON "alerts" ("loadId", "status") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_b63189bf8e5abf5b9188acca96" ON "alerts" ("status") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_f206618be4e26b7c883e9899ba" ON "alerts" ("severity") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_b5262085cf88e336618af2cc68" ON "alerts" ("type") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_143edd01c2f285d77e22f36a31" ON "alerts" ("loadId") `);
        await queryRunner.query(`CREATE TYPE "public"."loan_requests_status_enum" AS ENUM('pending', 'approved', 'rejected', 'disbursed', 'repaid', 'failed', 'defaulted')`);
        ...
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_66a4fdd8f06d536dc5ef659e8f" ON "trip_locations" ("latitude", "longitude") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_74f23daf6f2604f0adabfcac58" ON "trip_locations" ("driverId", "timestamp") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_78ec5cd2f445dee8ae15338ba5" ON "trip_locations" ("tripId", "timestamp") `);
        await queryRunner.query(`CREATE TYPE "public"."trip_events_type_enum" AS ENUM('TRIP_STARTED', 'TRIP_COMPLETED', 'TRIP_CANCELLED', 'PICKUP_ARRIVED', 'PICKUP_COMPLETED', 'DELIVERY_ARRIVED', 'DELIVERY_COMPLETED', 'ROUTE_DEVIATION', 'ETA_UPDATED', 'WEATHER_UPDATE', 'TRAFFIC_UPDATE', 'FUEL_STOP', 'REST_STOP', 'MAINTENANCE_STOP', 'CUSTOMER_CONTACT', 'DOCUMENT_UPLOADED', 'SIGNATURE_COLLECTED')`);
        await queryRunner.query(`CREATE TYPE "public"."trip_events_severity_enum" AS ENUM('INFO', 'WARNING', 'ERROR', 'CRITICAL')`);
        ...
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_bd901edc39205134d03cb76535" ON "trip_events" ("type", "severity") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_3589adc3f99b4733fba9b3b311" ON "trip_events" ("driverId", "createdAt") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_3267692da4aac579792dabc4a2" ON "trip_events" ("tripId", "type") `);
        await queryRunner.query(`CREATE TYPE "public"."geofences_type_enum" AS ENUM('PICKUP', 'DELIVERY', 'RESTRICTED', 'CUSTOM')`);
        await queryRunner.query(`CREATE TABLE "geofences" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "description" text, "type" "public"."geofences_type_enum" NOT NULL DEFAULT 'CUSTOM', "latitude" numeric(10,8) NOT NULL, "longitude" numeric(11,8) NOT NULL, "radius" numeric(8,2) NOT NULL, "polygon" jsonb, "isActive" boolean NOT NULL DEFAULT true, "settings" jsonb, "metadata" jsonb, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_1c858c4e20c26a6e5b2a1a10c82" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_41f05d0ab196734c957a5f94c5" ON "geofences" ("latitude", "longitude") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_5bb1f8300c1aa9af9f2773237c" ON "geofences" ("type", "isActive") `);
        await queryRunner.query(`CREATE TYPE "public"."driver_alerts_type_enum" AS ENUM('SPEEDING', 'HARD_BRAKING', 'HARD_ACCELERATION', 'SHARP_TURN', 'IDLE_TIME', 'OFF_ROUTE', 'EMERGENCY', 'BATTERY_LOW', 'GEOFENCE_VIOLATION', 'WEATHER_ALERT', 'MAINTENANCE_ALERT')`);
        await queryRunner.query(`CREATE TYPE "public"."driver_alerts_severity_enum" AS ENUM('LOW', 'MEDIUM', 'HIGH', 'CRITICAL')`);
        await queryRunner.query(`CREATE TYPE "public"."driver_alerts_status_enum" AS ENUM('ACTIVE', 'ACKNOWLEDGED', 'RESOLVED', 'DISMISSED')`);
        await queryRunner.query(`CREATE TABLE "driver_alerts" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "driverId" character varying NOT NULL, "tripId" character varying, "type" "public"."driver_alerts_type_enum" NOT NULL, "severity" "public"."driver_alerts_severity_enum" NOT NULL DEFAULT 'MEDIUM', "status" "public"."driver_alerts_status_enum" NOT NULL DEFAULT 'ACTIVE', "title" character varying NOT NULL, "message" text NOT NULL, "latitude" numeric(10,8), "longitude" numeric(11,8), "speed" numeric(5,2), "data" jsonb, "acknowledgedAt" TIMESTAMP, "acknowledgedBy" character varying, "resolvedAt" TIMESTAMP, "resolvedBy" character varying, "metadata" jsonb, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_28b35bf619e38d94c3f53c495c3" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_9fb62928ec18d06acd906abe59" ON "driver_alerts" ("createdAt") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_876df290ec8bb81ffa45901b5a" ON "driver_alerts" ("type", "severity") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_8f0b90cfcb9a320d316c792f60" ON "driver_alerts" ("tripId", "status") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_2d1bc20ea70fb8d1fb8ea6eb51" ON "driver_alerts" ("driverId", "status") `);
        await queryRunner.query(`CREATE TYPE "public"."pricing_predictions_status_enum" AS ENUM('pending', 'processed', 'failed', 'validated', 'rejected')`);
        await queryRunner.query(`CREATE TABLE "pricing_predictions" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "tenantId" uuid NOT NULL, "modelId" uuid NOT NULL, "tripId" uuid, "loadId" uuid, "truckId" uuid, "driverId" uuid, "status" "public"."pricing_predictions_status_enum" NOT NULL DEFAULT 'pending', "distance" numeric(10,2) NOT NULL, "weight" numeric(10,2) NOT NULL, "volume" numeric(10,2) NOT NULL, "originLocation" character varying(255) NOT NULL, "destinationLocation" character varying(255) NOT NULL, "routeComplexity" jsonb NOT NULL, "marketConditions" jsonb NOT NULL, "truckAvailability" jsonb NOT NULL, "driverMetrics" jsonb NOT NULL, "environmentalFactors" jsonb NOT NULL, "temporalFeatures" jsonb NOT NULL, "cargoFeatures" jsonb NOT NULL, "predictedPrice" numeric(12,2) NOT NULL, "actualPrice" numeric(12,2), "predictionAccuracy" numeric(10,2), "predictionError" numeric(10,2), "confidenceInterval" numeric(12,2) NOT NULL, "featureContributions" jsonb NOT NULL, "shapValues" jsonb NOT NULL, "limeExplanation" jsonb NOT NULL, "inferenceTime" numeric(10,4) NOT NULL, "modelVersion" jsonb NOT NULL, "isAccepted" boolean NOT NULL DEFAULT false, "isRejected" boolean NOT NULL DEFAULT false, "rejectionReason" character varying(255), "acceptedPrice" numeric(12,2), "acceptedAt" TIMESTAMP, "acceptedBy" character varying(255), "abTestGroup" character varying(50), "isABTest" boolean NOT NULL DEFAULT false, "biasMetrics" jsonb, "isAnomaly" boolean NOT NULL DEFAULT false, "anomalyScore" numeric(10,4), "driftMetrics" jsonb, "metadata" jsonb, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "predictedAt" TIMESTAMP, "validatedAt" TIMESTAMP, CONSTRAINT "PK_08c32e60bd43778416f424e5701" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_33d10083cddf802f824f537e86" ON "pricing_predictions" ("predictedAt") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_812cb7cef1a3b868ec9aeb532a" ON "pricing_predictions" ("tripId") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_f87cff4fc4d3a190d5ad231b4a" ON "pricing_predictions" ("modelId", "createdAt") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_bfb0f932879521ce30397dd1be" ON "pricing_predictions" ("tenantId", "status") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_7bf38a558895c578d35ea19a94" ON "pricing_predictions" ("tenantId", "modelId") `);
        await queryRunner.query(`CREATE TYPE "public"."pricing_models_modeltype_enum" AS ENUM('linear_regression', 'random_forest', 'gradient_boosting', 'neural_network', 'ensemble', 'custom')`);
        await queryRunner.query(`CREATE TYPE "public"."pricing_models_version_enum" AS ENUM('v1.0', 'v1.1', 'v2.0', 'v2.1', 'beta')`);
        await queryRunner.query(`CREATE TYPE "public"."pricing_models_status_enum" AS ENUM('training', 'active', 'inactive', 'deprecated', 'failed')`);
        await queryRunner.query(`CREATE TABLE "pricing_models" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "tenantId" uuid NOT NULL, "name" character varying(255) NOT NULL, "description" character varying(255) NOT NULL, "modelType" "public"."pricing_models_modeltype_enum" NOT NULL DEFAULT 'gradient_boosting', "version" "public"."pricing_models_version_enum" NOT NULL DEFAULT 'v1.0', "status" "public"."pricing_models_status_enum" NOT NULL DEFAULT 'inactive', "modelPath" character varying(255), "hyperparameters" jsonb, "featureConfig" jsonb, "performanceMetrics" jsonb, "trainingMetrics" jsonb, "biasMetrics" jsonb, "explainabilityMetrics" jsonb, "aBTestConfig" jsonb, "monitoringConfig" jsonb, "lastTrainingDate" TIMESTAMP, "lastInferenceDate" TIMESTAMP, "nextRetrainingDate" TIMESTAMP, "totalInferences" integer NOT NULL DEFAULT '0', "averageInferenceTime" numeric(10,2) NOT NULL DEFAULT '0', "averagePredictionAccuracy" numeric(10,2) NOT NULL DEFAULT '0', "metadata" jsonb, "createdBy" character varying(255), "updatedBy" character varying(255), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_2d5c719fee2b6e2f857a67fc6b4" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_a5a95c2eb289dbb91ed5399bb9" ON "pricing_models" ("createdAt") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_28a3a367424398db63e6cc68a5" ON "pricing_models" ("version", "status") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_5d884262384edc276df2b0ef4b" ON "pricing_models" ("tenantId", "modelType") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_17fe5d255209b618bc0f8c768d" ON "pricing_models" ("tenantId", "status") `);
        await queryRunner.query(`CREATE TYPE "public"."pricing_features_featuretype_enum" AS ENUM('numerical', 'categorical', 'temporal', 'geospatial', 'text', 'boolean', 'composite')`);
        await queryRunner.query(`CREATE TYPE "public"."pricing_features_featuresource_enum" AS ENUM('trip_data', 'market_data', 'weather_data', 'traffic_data', 'fuel_data', 'driver_data', 'truck_data', 'external_api', 'computed')`);
        await queryRunner.query(`CREATE TABLE "pricing_features" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "tenantId" uuid NOT NULL, "featureName" character varying(255) NOT NULL, "description" character varying(500) NOT NULL, "featureType" "public"."pricing_features_featuretype_enum" NOT NULL DEFAULT 'numerical', "featureSource" "public"."pricing_features_featuresource_enum" NOT NULL DEFAULT 'computed', "dataType" character varying(255) NOT NULL, "isActive" boolean NOT NULL DEFAULT true, "isRequired" boolean NOT NULL DEFAULT false, "importance" integer NOT NULL DEFAULT '0', "correlationWithTarget" numeric(10,4), "statistics" jsonb, "preprocessing" jsonb, "validation" jsonb, "driftMetrics" jsonb, "biasMetrics" jsonb, "featureEngineering" jsonb, "qualityMetrics" jsonb, "metadata" jsonb, "createdBy" character varying(255), "updatedBy" character varying(255), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_0a2bc88284be8bf2a98145aacbf" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_be0cae5943aeb3a2aaa4344ef1" ON "pricing_features" ("isActive") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_f39e8d6b34aaaf11c37d3f64bf" ON "pricing_features" ("featureName", "tenantId") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_677b7a8c0a08cfa3c23c699d76" ON "pricing_features" ("tenantId", "featureSource") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_8eedc2f59890953881e6176186" ON "pricing_features" ("tenantId", "featureType") `);
        await queryRunner.query(`CREATE TYPE "public"."notification_templates_type_enum" AS ENUM('email', 'sms', 'push', 'in_app')`);
        await queryRunner.query(`CREATE TYPE "public"."notification_templates_category_enum" AS ENUM('trip_status', 'payment', 'safety', 'performance', 'maintenance', 'system', 'marketing')`);
        ...
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_4ec35888951e02b2898f54fd26" ON "notification_templates" ("isActive", "category") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_e48756cbf41b42cb414abe1966" ON "notification_templates" ("tenantId", "language") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_2191a1db3a22d1d2a8e055601d" ON "notification_templates" ("tenantId", "type") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_a1b8057b12c7bf4e7e61856662" ON "notification_templates" ("tenantId", "category") `);
        await queryRunner.query(`CREATE TYPE "public"."notification_preferences_category_enum" AS ENUM('trip_status', 'payment', 'safety', 'performance', 'maintenance', 'system', 'marketing')`);
        await queryRunner.query(`CREATE TYPE "public"."notification_preferences_channel_enum" AS ENUM('email', 'sms', 'push', 'in_app')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."invoice_items_type_enum" AS ENUM('freight', 'fuel_surcharge', 'toll', 'detention', 'lumper', 'accessorial')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."expenses_type_enum" AS ENUM('fuel', 'maintenance', 'toll', 'driver', 'insurance', 'tax', 'other')`);
        ...
        await queryRunner.query(`CREATE TABLE "lender_role_permissions" ("role_id" uuid NOT NULL, "permission_id" uuid NOT NULL, CONSTRAINT "PK_ff6d1f74bc7c2c32132bf363176" PRIMARY KEY ("role_id", "permission_id"))`);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_05f0a14b055bab4011e9b58f09" ON "lender_role_permissions" ("role_id") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_f4803284da86c04ffbab09e0a1" ON "lender_role_permissions" ("permission_id") `);
        await queryRunner.query(`CREATE TABLE "lender_user_permissions" ("user_id" uuid NOT NULL, "permission_id" uuid NOT NULL, CONSTRAINT "PK_efe23dd2442a22b29b8c439121f" PRIMARY KEY ("user_id", "permission_id"))`);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_05f55bf74e2b5ba8b79b6f3b1c" ON "lender_user_permissions" ("user_id") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_3e247569401d14be97b1d99928" ON "lender_user_permissions" ("permission_id") `);
...
END$$;`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."insurance_claims_claimtype_enum" AS ENUM('collision', 'theft', 'vandalism', 'weather_damage', 'cargo_damage', 'cargo_theft', 'fire', 'flood', 'mechanical_breakdown', 'roadside_assistance', 'medical', 'liability', 'other')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."insurance_claims_status_enum" AS ENUM('pending', 'investigating', 'approved', 'denied', 'closed', 'under_review', 'settlement_pending')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."insurance_policies_policytype_enum" AS ENUM('liability', 'collision', 'comprehensive', 'cargo', 'uninsured_motorist', 'medical_payments', 'roadside_assistance', 'rental_reimbursement', 'full_coverage', 'commercial')`);
        ...
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_baa50eb26aac0be1b692c080fb" ON "insurance_policies" ("policyNumber") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_e18ea109a1f68c3868b032a089" ON "insurance_policies" ("insuranceCompany") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_b8bbfc223669bc00cb06098742" ON "rate_limits" ("tenantId", "createdAt") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_282e04b4fee53dc581d40d5df6" ON "rate_limits" ("tenantId", "endpoint", "createdAt") `);
        ...
        await queryRunner.query(`ALTER TABLE "loads" ADD CONSTRAINT "FK_4bf0030a3bc50c87ee9d62150a2" FOREIGN KEY ("cargoOwnerId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "bids" ADD CONSTRAINT "FK_d03cf356cf1520672d4488244b7" FOREIGN KEY ("loadId") REFERENCES "loads"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "bids" ADD CONSTRAINT "FK_0d1ebe448cb691f63a2015d458c" FOREIGN KEY ("truckOwnerId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "auction_watches" ADD CONSTRAINT "FK_d3760adc87d5ee1caf1c68ca97c" FOREIGN KEY ("auctionId") REFERENCES "auctions"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "auction_watches" ADD CONSTRAINT "FK_9f9960cdacdc7629eab791a2408" FOREIGN KEY ("watcherId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "auctions" ADD CONSTRAINT "FK_0e1f240cbe7467e649e0a22f972" FOREIGN KEY ("loadId") REFERENCES "loads"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "auctions" ADD CONSTRAINT "FK_f56f0d097f1fb02c07d6bdc368d" FOREIGN KEY ("winningBidId") REFERENCES "bids"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "auction_views" ADD CONSTRAINT "FK_2fd049894571ed29326f6d1e667" FOREIGN KEY ("auctionId") REFERENCES "auctions"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "auction_views" ADD CONSTRAINT "FK_e6b9cee53d8f990822f329ee238" FOREIGN KEY ("viewerId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "trucks" ADD CONSTRAINT "FK_6dd25f279d65cf40f903d973dd1" FOREIGN KEY ("ownerId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "trips" ADD CONSTRAINT "FK_b076d66a33644c5f3f35b00342c" FOREIGN KEY ("pickupLocationId") REFERENCES "locations"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "trips" ADD CONSTRAINT "FK_45e6ba84f89d222f6ec3491b32b" FOREIGN KEY ("deliveryLocationId") REFERENCES "locations"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "trips" ADD CONSTRAINT "FK_e09340a38a920ef5d5cc1d9cb7c" FOREIGN KEY ("loadId") REFERENCES "loads"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "trips" ADD CONSTRAINT "FK_700f7e9137180e091c2e8343f06" FOREIGN KEY ("truckId") REFERENCES "trucks"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "tracking_events" ADD CONSTRAINT "FK_a409b6270ed1bfc522ab31d8981" FOREIGN KEY ("loadId") REFERENCES "loads"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "tracking_events" ADD CONSTRAINT "FK_2d3799e247f548a6b445aa794b8" FOREIGN KEY ("reportedBy") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "tracking_events" ADD CONSTRAINT "FK_6be8ea49959fe857b2c0c98facc" FOREIGN KEY ("actionTakenBy") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "route_trucks" ADD CONSTRAINT "FK_09edcc3902bee3dcf05426e3d2d" FOREIGN KEY ("routeId") REFERENCES "routes"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "price_suggestions" ADD CONSTRAINT "FK_3cdb9a8e7d235c139d649662792" FOREIGN KEY ("loadId") REFERENCES "loads"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "price_suggestions" ADD CONSTRAINT "FK_2e06bee7a3b9401f2189535e6f8" FOREIGN KEY ("acceptedBy") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "price_suggestions" ADD CONSTRAINT "FK_ddf6e4dedc1cb6a49fb8a565393" FOREIGN KEY ("rejectedBy") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "payments" ADD CONSTRAINT "FK_4277aa2c0e3a4a3591474dbea2f" FOREIGN KEY ("tripId") REFERENCES "trips"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "load_templates" ADD CONSTRAINT "FK_bc954d3f801a7247cf678b4a9f5" FOREIGN KEY ("createdBy") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "insurance_claims" ADD CONSTRAINT "FK_ef0233f5751c8f5bb838dcc9c51" FOREIGN KEY ("policyId") REFERENCES "insurance_policies"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "insurance_policies" ADD CONSTRAINT "FK_acda968d16da059e4f098246552" FOREIGN KEY ("truckId") REFERENCES "trucks"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "insurance_renewals" ADD CONSTRAINT "FK_febfac3b7bf38da9b119fa050ae" FOREIGN KEY ("policyId") REFERENCES "insurance_policies"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "insurance_renewals" ADD CONSTRAINT "FK_4443a0125e443faf35976c0d073" FOREIGN KEY ("truckId") REFERENCES "trucks"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "disputes" ADD CONSTRAINT "FK_8880a40e54bc9b4675323ca102e" FOREIGN KEY ("raisedById") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "disputes" ADD CONSTRAINT "FK_f591a79141f5e603d8e6b10db11" FOREIGN KEY ("tripId") REFERENCES "trips"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "audit_events" ADD CONSTRAINT "FK_fe948a2ef9575a943c46a916f50" FOREIGN KEY ("loadId") REFERENCES "loads"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "audit_events" ADD CONSTRAINT "FK_9e76ea4cc84a0e407c5a3aeb054" FOREIGN KEY ("actorId") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "audit_events" ADD CONSTRAINT "FK_b1b19e63b886fdc36c0ebb82def" FOREIGN KEY ("reviewedBy") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "alerts" ADD CONSTRAINT "FK_143edd01c2f285d77e22f36a31b" FOREIGN KEY ("loadId") REFERENCES "loads"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "alerts" ADD CONSTRAINT "FK_c54fca4a363bf6977b1146d6cdf" FOREIGN KEY ("acknowledgedBy") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "alerts" ADD CONSTRAINT "FK_42c6341f1c3237def4a2af12424" FOREIGN KEY ("resolvedBy") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "alerts" ADD CONSTRAINT "FK_f86b0d6f23d3f1dde6df15df021" FOREIGN KEY ("closedBy") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "alerts" ADD CONSTRAINT "FK_308bd80c9ad3eaf333a364e533a" FOREIGN KEY ("escalatedTo") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "loan_requests" ADD CONSTRAINT "FK_e9e0a90731bc470fedbbc86ecea" FOREIGN KEY ("lender_id") REFERENCES "lenders"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "loan_requests" ADD CONSTRAINT "FK_aec634ccd19e42612dc7a8f8a8f" FOREIGN KEY ("borrower_id") REFERENCES "borrowers"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "loan_repayments" ADD CONSTRAINT "FK_21ef1bd34fb44422d1acce46d20" FOREIGN KEY ("loan_request_id") REFERENCES "loan_requests"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "loan_disbursements" ADD CONSTRAINT "FK_080b5296a5d57fceec56f5bbf01" FOREIGN KEY ("loan_request_id") REFERENCES "loan_requests"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "lender_users" ADD CONSTRAINT "FK_d041faf14d43d9a3202724c8c7f" FOREIGN KEY ("lender_id") REFERENCES "lenders"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "lender_users" ADD CONSTRAINT "FK_a2659dfe46e333e729ff6f22234" FOREIGN KEY ("role_id") REFERENCES "lender_roles"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "lender_policies" ADD CONSTRAINT "FK_d5433e3c9e1a61a66a2f7b678b0" FOREIGN KEY ("lender_id") REFERENCES "lenders"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "pricing_predictions" ADD CONSTRAINT "FK_94966b7fa18a25f9933d266de6c" FOREIGN KEY ("tenantId") REFERENCES "tenants"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "pricing_models" ADD CONSTRAINT "FK_619a63b581d7dda86a9397ac11f" FOREIGN KEY ("tenantId") REFERENCES "tenants"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "pricing_features" ADD CONSTRAINT "FK_30a4db7e195d7052044f7e61989" FOREIGN KEY ("tenantId") REFERENCES "tenants"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "notification_templates" ADD CONSTRAINT "FK_53c96a011fdb6f8c6b700c961e4" FOREIGN KEY ("tenantId") REFERENCES "tenants"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "policy_renewals" ADD CONSTRAINT "FK_33d20468ee0b5047ec0eed6c83c" FOREIGN KEY ("policyId") REFERENCES "insurance_policies"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "policy_renewals" ADD CONSTRAINT "FK_31774d7030411ceefb456f755f7" FOREIGN KEY ("tenantId") REFERENCES "tenants"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "policy_renewals" ADD CONSTRAINT "FK_2471353f202ba285efdc86a0e3f" FOREIGN KEY ("createdBy") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "policy_renewals" ADD CONSTRAINT "FK_52284aca09e41f7c8c1877be93f" FOREIGN KEY ("approvedBy") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "financial_payments" ADD CONSTRAINT "FK_d54d26d16a013ca9f7aaf39a830" FOREIGN KEY ("createdBy") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "financial_payments" ADD CONSTRAINT "FK_63aa462e621b1db98ceb226b49d" FOREIGN KEY ("tenantId") REFERENCES "tenants"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "tax_records" ADD CONSTRAINT "FK_b2849b7dc980ca04e449457399a" FOREIGN KEY ("createdBy") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "tax_records" ADD CONSTRAINT "FK_a3787b66405b239bc4c0cef4948" FOREIGN KEY ("tenantId") REFERENCES "tenants"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "invoices" ADD CONSTRAINT "FK_916db332df1248d4325ff4e5016" FOREIGN KEY ("createdBy") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "financial_reports" ADD CONSTRAINT "FK_0f70431b951afb6b76d37f631ec" FOREIGN KEY ("createdBy") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "financial_reports" ADD CONSTRAINT "FK_597a1287239ba4a3fbbec552cfb" FOREIGN KEY ("tenantId") REFERENCES "tenants"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "budgets" ADD CONSTRAINT "FK_585cf990e152374b53e2f602a41" FOREIGN KEY ("createdBy") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "budgets" ADD CONSTRAINT "FK_066b8b7c71df90bb31ea952a50d" FOREIGN KEY ("tenantId") REFERENCES "tenants"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "lender_role_permissions" ADD CONSTRAINT "FK_05f0a14b055bab4011e9b58f09e" FOREIGN KEY ("role_id") REFERENCES "lender_roles"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "lender_role_permissions" ADD CONSTRAINT "FK_f4803284da86c04ffbab09e0a1e" FOREIGN KEY ("permission_id") REFERENCES "lender_permissions"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "lender_user_permissions" ADD CONSTRAINT "FK_05f55bf74e2b5ba8b79b6f3b1c4" FOREIGN KEY ("user_id") REFERENCES "lender_users"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "lender_user_permissions" ADD CONSTRAINT "FK_3e247569401d14be97b1d999287" FOREIGN KEY ("permission_id") REFERENCES "lender_permissions"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "lender_user_permissions" DROP CONSTRAINT "FK_3e247569401d14be97b1d999287"`);
        await queryRunner.query(`ALTER TABLE "lender_user_permissions" DROP CONSTRAINT "FK_05f55bf74e2b5ba8b79b6f3b1c4"`);
        await queryRunner.query(`ALTER TABLE "lender_role_permissions" DROP CONSTRAINT "FK_f4803284da86c04ffbab09e0a1e"`);
        await queryRunner.query(`ALTER TABLE "lender_role_permissions" DROP CONSTRAINT "FK_05f0a14b055bab4011e9b58f09e"`);
        await queryRunner.query(`ALTER TABLE "budgets" DROP CONSTRAINT "FK_066b8b7c71df90bb31ea952a50d"`);
        await queryRunner.query(`ALTER TABLE "budgets" DROP CONSTRAINT "FK_585cf990e152374b53e2f602a41"`);
        await queryRunner.query(`ALTER TABLE "financial_reports" DROP CONSTRAINT "FK_597a1287239ba4a3fbbec552cfb"`);
        await queryRunner.query(`ALTER TABLE "financial_reports" DROP CONSTRAINT "FK_0f70431b951afb6b76d37f631ec"`);
        ...
        await queryRunner.query(`ALTER TABLE "invoices" DROP CONSTRAINT "FK_916db332df1248d4325ff4e5016"`);
        await queryRunner.query(`ALTER TABLE "tax_records" DROP CONSTRAINT "FK_a3787b66405b239bc4c0cef4948"`);
        await queryRunner.query(`ALTER TABLE "tax_records" DROP CONSTRAINT "FK_b2849b7dc980ca04e449457399a"`);
        await queryRunner.query(`ALTER TABLE "financial_payments" DROP CONSTRAINT "FK_63aa462e621b1db98ceb226b49d"`);
        await queryRunner.query(`ALTER TABLE "financial_payments" DROP CONSTRAINT "FK_d54d26d16a013ca9f7aaf39a830"`);
        await queryRunner.query(`ALTER TABLE "policy_renewals" DROP CONSTRAINT "FK_52284aca09e41f7c8c1877be93f"`);
        await queryRunner.query(`ALTER TABLE "policy_renewals" DROP CONSTRAINT "FK_2471353f202ba285efdc86a0e3f"`);
        await queryRunner.query(`ALTER TABLE "policy_renewals" DROP CONSTRAINT "FK_31774d7030411ceefb456f755f7"`);
        await queryRunner.query(`ALTER TABLE "policy_renewals" DROP CONSTRAINT "FK_33d20468ee0b5047ec0eed6c83c"`);
        ...
        await queryRunner.query(`ALTER TABLE "notification_preferences" DROP CONSTRAINT "FK_b3403e8b519a383776f6c693cc9"`);
        await queryRunner.query(`ALTER TABLE "notification_preferences" DROP CONSTRAINT "FK_b70c44e8b00757584a393225593"`);
        await queryRunner.query(`ALTER TABLE "notification_templates" DROP CONSTRAINT "FK_53c96a011fdb6f8c6b700c961e4"`);
        await queryRunner.query(`ALTER TABLE "pricing_features" DROP CONSTRAINT "FK_30a4db7e195d7052044f7e61989"`);
        await queryRunner.query(`ALTER TABLE "pricing_models" DROP CONSTRAINT "FK_619a63b581d7dda86a9397ac11f"`);
        await queryRunner.query(`ALTER TABLE "pricing_predictions" DROP CONSTRAINT "FK_94966b7fa18a25f9933d266de6c"`);
        await queryRunner.query(`ALTER TABLE "lender_policies" DROP CONSTRAINT "FK_d5433e3c9e1a61a66a2f7b678b0"`);
        await queryRunner.query(`ALTER TABLE "lender_users" DROP CONSTRAINT "FK_a2659dfe46e333e729ff6f22234"`);
        await queryRunner.query(`ALTER TABLE "lender_users" DROP CONSTRAINT "FK_d041faf14d43d9a3202724c8c7f"`);
        await queryRunner.query(`ALTER TABLE "loan_disbursements" DROP CONSTRAINT "FK_080b5296a5d57fceec56f5bbf01"`);
        await queryRunner.query(`ALTER TABLE "loan_repayments" DROP CONSTRAINT "FK_21ef1bd34fb44422d1acce46d20"`);
        await queryRunner.query(`ALTER TABLE "loan_requests" DROP CONSTRAINT "FK_aec634ccd19e42612dc7a8f8a8f"`);
        await queryRunner.query(`ALTER TABLE "loan_requests" DROP CONSTRAINT "FK_e9e0a90731bc470fedbbc86ecea"`);
        await queryRunner.query(`ALTER TABLE "alerts" DROP CONSTRAINT "FK_308bd80c9ad3eaf333a364e533a"`);
        await queryRunner.query(`ALTER TABLE "alerts" DROP CONSTRAINT "FK_f86b0d6f23d3f1dde6df15df021"`);
        await queryRunner.query(`ALTER TABLE "alerts" DROP CONSTRAINT "FK_42c6341f1c3237def4a2af12424"`);
        await queryRunner.query(`ALTER TABLE "alerts" DROP CONSTRAINT "FK_c54fca4a363bf6977b1146d6cdf"`);
        await queryRunner.query(`ALTER TABLE "alerts" DROP CONSTRAINT "FK_143edd01c2f285d77e22f36a31b"`);
        await queryRunner.query(`ALTER TABLE "audit_events" DROP CONSTRAINT "FK_b1b19e63b886fdc36c0ebb82def"`);
        await queryRunner.query(`ALTER TABLE "audit_events" DROP CONSTRAINT "FK_9e76ea4cc84a0e407c5a3aeb054"`);
        await queryRunner.query(`ALTER TABLE "audit_events" DROP CONSTRAINT "FK_fe948a2ef9575a943c46a916f50"`);
        await queryRunner.query(`ALTER TABLE "audit_logs" DROP CONSTRAINT "FK_cfa83f61e4d27a87fcae1e025ab"`);
        await queryRunner.query(`ALTER TABLE "disputes" DROP CONSTRAINT "FK_f591a79141f5e603d8e6b10db11"`);
        await queryRunner.query(`ALTER TABLE "disputes" DROP CONSTRAINT "FK_8880a40e54bc9b4675323ca102e"`);
        await queryRunner.query(`ALTER TABLE "insurance_renewals" DROP CONSTRAINT "FK_4443a0125e443faf35976c0d073"`);
        await queryRunner.query(`ALTER TABLE "insurance_renewals" DROP CONSTRAINT "FK_febfac3b7bf38da9b119fa050ae"`);
        await queryRunner.query(`ALTER TABLE "insurance_policies" DROP CONSTRAINT "FK_acda968d16da059e4f098246552"`);
        await queryRunner.query(`ALTER TABLE "insurance_claims" DROP CONSTRAINT "FK_58b6d392b802763fda1b8cdd21d"`);
        await queryRunner.query(`ALTER TABLE "insurance_claims" DROP CONSTRAINT "FK_ef0233f5751c8f5bb838dcc9c51"`);
        await queryRunner.query(`ALTER TABLE "load_templates" DROP CONSTRAINT "FK_bc954d3f801a7247cf678b4a9f5"`);
        await queryRunner.query(`ALTER TABLE "payments" DROP CONSTRAINT "FK_4277aa2c0e3a4a3591474dbea2f"`);
        await queryRunner.query(`ALTER TABLE "price_suggestions" DROP CONSTRAINT "FK_ddf6e4dedc1cb6a49fb8a565393"`);
        await queryRunner.query(`ALTER TABLE "price_suggestions" DROP CONSTRAINT "FK_2e06bee7a3b9401f2189535e6f8"`);
        await queryRunner.query(`ALTER TABLE "price_suggestions" DROP CONSTRAINT "FK_3cdb9a8e7d235c139d649662792"`);
        await queryRunner.query(`ALTER TABLE "route_trucks" DROP CONSTRAINT "FK_09edcc3902bee3dcf05426e3d2d"`);
        await queryRunner.query(`ALTER TABLE "tracking_events" DROP CONSTRAINT "FK_6be8ea49959fe857b2c0c98facc"`);
        await queryRunner.query(`ALTER TABLE "tracking_events" DROP CONSTRAINT "FK_2d3799e247f548a6b445aa794b8"`);
        await queryRunner.query(`ALTER TABLE "tracking_events" DROP CONSTRAINT "FK_a409b6270ed1bfc522ab31d8981"`);
        await queryRunner.query(`ALTER TABLE "trips" DROP CONSTRAINT "FK_fc5a8911f85074a660a4304baa1"`);
        await queryRunner.query(`ALTER TABLE "trips" DROP CONSTRAINT "FK_700f7e9137180e091c2e8343f06"`);
        await queryRunner.query(`ALTER TABLE "trips" DROP CONSTRAINT "FK_e09340a38a920ef5d5cc1d9cb7c"`);
        await queryRunner.query(`ALTER TABLE "trips" DROP CONSTRAINT "FK_45e6ba84f89d222f6ec3491b32b"`);
        await queryRunner.query(`ALTER TABLE "trips" DROP CONSTRAINT "FK_b076d66a33644c5f3f35b00342c"`);
        await queryRunner.query(`ALTER TABLE "trucks" DROP CONSTRAINT "FK_6dd25f279d65cf40f903d973dd1"`);
        await queryRunner.query(`ALTER TABLE "users" DROP CONSTRAINT "FK_c58f7e88c286e5e3478960a998b"`);
        await queryRunner.query(`ALTER TABLE "auction_views" DROP CONSTRAINT "FK_e6b9cee53d8f990822f329ee238"`);
        await queryRunner.query(`ALTER TABLE "auction_views" DROP CONSTRAINT "FK_2fd049894571ed29326f6d1e667"`);
        await queryRunner.query(`ALTER TABLE "auctions" DROP CONSTRAINT "FK_f56f0d097f1fb02c07d6bdc368d"`);
        await queryRunner.query(`ALTER TABLE "auctions" DROP CONSTRAINT "FK_0e1f240cbe7467e649e0a22f972"`);
        await queryRunner.query(`ALTER TABLE "auction_watches" DROP CONSTRAINT "FK_9f9960cdacdc7629eab791a2408"`);
        await queryRunner.query(`ALTER TABLE "auction_watches" DROP CONSTRAINT "FK_d3760adc87d5ee1caf1c68ca97c"`);
        await queryRunner.query(`ALTER TABLE "bids" DROP CONSTRAINT "FK_0d1ebe448cb691f63a2015d458c"`);
        await queryRunner.query(`ALTER TABLE "bids" DROP CONSTRAINT "FK_d03cf356cf1520672d4488244b7"`);
        await queryRunner.query(`ALTER TABLE "loads" DROP CONSTRAINT "FK_4bf0030a3bc50c87ee9d62150a2"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_282e04b4fee53dc581d40d5df6"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_b8bbfc223669bc00cb06098742"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_e18ea109a1f68c3868b032a089"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_baa50eb26aac0be1b692c080fb"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_58b6d392b802763fda1b8cdd21"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_7c69728b0eee8df90aa28cb3aa"`);
        await queryRunner.query(`ALTER TABLE "insurance_policies" ALTER COLUMN "deductible" TYPE numeric(15,2)`);
        await queryRunner.query(`CREATE TYPE "public"."insurance_policies_policytype_enum_old" AS ENUM('liability', 'collision', 'comprehensive', 'cargo', 'uninsured_motorist', 'roadside', 'medical')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."insurance_claims_status_enum_old" AS ENUM('pending', 'investigating', 'approved', 'denied', 'closed', 'under_review')`);
        await queryRunner.query(`ALTER TABLE "insurance_claims" ALTER COLUMN "status" DROP DEFAULT`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."insurance_claims_claimtype_enum_old" AS ENUM('collision', 'cargo_damage', 'theft', 'weather', 'liability', 'medical', 'roadside', 'other')`);
        ...
        await queryRunner.query(`ALTER TABLE "insurance_claims" ADD "truckId" uuid NOT NULL`);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_58b6d392b802763fda1b8cdd21" ON "insurance_claims" ("truckId") `);
        await queryRunner.query(`DROP INDEX "public"."IDX_3e247569401d14be97b1d99928"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_05f55bf74e2b5ba8b79b6f3b1c"`);
        await queryRunner.query(`DROP TABLE "lender_user_permissions"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_f4803284da86c04ffbab09e0a1"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_05f0a14b055bab4011e9b58f09"`);
        await queryRunner.query(`DROP TABLE "lender_role_permissions"`);
        await queryRunner.query(`DROP TABLE "budgets"`);
        await queryRunner.query(`DROP TABLE "financial_reports"`);
        await queryRunner.query(`DROP TYPE "public"."financial_reports_period_enum"`);
        ...
        await queryRunner.query(`DROP TYPE "public"."financial_payments_status_enum"`);
        await queryRunner.query(`DROP TYPE "public"."financial_payments_paymentmethod_enum"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_cd480bbedf6d4b5c314008ff42"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_6745a98293a7d8dd3948b688e2"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_2be89a736c62dfb88480bb8865"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_150613de3612941b1e1b921e06"`);
        await queryRunner.query(`DROP TABLE "policy_renewals"`);
        await queryRunner.query(`DROP TYPE "public"."policy_renewals_renewaltype_enum"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_8facef03fbe2ee514e7fe7fe14"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_a1b8057b12c7bf4e7e61856662"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_2191a1db3a22d1d2a8e055601d"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_e48756cbf41b42cb414abe1966"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_4ec35888951e02b2898f54fd26"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_8eedc2f59890953881e6176186"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_677b7a8c0a08cfa3c23c699d76"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_f39e8d6b34aaaf11c37d3f64bf"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_be0cae5943aeb3a2aaa4344ef1"`);
        await queryRunner.query(`DROP TABLE "pricing_features"`);
        await queryRunner.query(`DROP TYPE "public"."pricing_features_featuresource_enum"`);
        await queryRunner.query(`DROP TYPE "public"."pricing_features_featuretype_enum"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_17fe5d255209b618bc0f8c768d"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_5d884262384edc276df2b0ef4b"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_28a3a367424398db63e6cc68a5"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_a5a95c2eb289dbb91ed5399bb9"`);
        ...
        await queryRunner.query(`DROP TYPE "public"."pricing_models_modeltype_enum"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_7bf38a558895c578d35ea19a94"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_bfb0f932879521ce30397dd1be"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_f87cff4fc4d3a190d5ad231b4a"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_812cb7cef1a3b868ec9aeb532a"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_33d10083cddf802f824f537e86"`);
        await queryRunner.query(`DROP TABLE "pricing_predictions"`);
        await queryRunner.query(`DROP TYPE "public"."pricing_predictions_status_enum"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_2d1bc20ea70fb8d1fb8ea6eb51"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_8f0b90cfcb9a320d316c792f60"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_876df290ec8bb81ffa45901b5a"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_9fb62928ec18d06acd906abe59"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_5bb1f8300c1aa9af9f2773237c"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_41f05d0ab196734c957a5f94c5"`);
        await queryRunner.query(`DROP TABLE "geofences"`);
        await queryRunner.query(`DROP TYPE "public"."geofences_type_enum"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_3267692da4aac579792dabc4a2"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_3589adc3f99b4733fba9b3b311"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_bd901edc39205134d03cb76535"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_78ec5cd2f445dee8ae15338ba5"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_74f23daf6f2604f0adabfcac58"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_66a4fdd8f06d536dc5ef659e8f"`);
        ...
        await queryRunner.query(`DROP TYPE "public"."lender_permissions_level_enum"`);
        await queryRunner.query(`DROP TYPE "public"."lender_permissions_category_enum"`);
        ...
        await queryRunner.query(`DROP TYPE "public"."loan_disbursements_disbursement_method_enum"`);
        await queryRunner.query(`DROP TYPE "public"."loan_disbursements_priority_enum"`);
        await queryRunner.query(`DROP TYPE "public"."loan_disbursements_status_enum"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_143edd01c2f285d77e22f36a31"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_b5262085cf88e336618af2cc68"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_619841f80de96e6b1f03ecc8e5"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_8bb8f7c97396b99b57794c5999"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_143edd01c2f285d77e22f36a31"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_fe948a2ef9575a943c46a916f5"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_03dea5ad2fc208f12145bd5b99"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_3a68652a2168db305c9e592b84"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_9e76ea4cc84a0e407c5a3aeb05"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_fe948a2ef9575a943c46a916f5"`);
        await queryRunner.query(`DROP TABLE "audit_events"`);
        await queryRunner.query(`DROP TYPE "public"."audit_events_action_enum"`);
        await queryRunner.query(`DROP TYPE "public"."audit_events_entitytype_enum"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_95476c2fe1b629671d3e6e7514"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_cfc95e4fa2aa210b2ac4b359cd"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_caecdab3f292c1620e81f8430d"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_26cbb28d32120560be2b429b90"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_4655f11878f993987b6c1c3f3d"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_6010dc81933f1fdba08e89f76a"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_54c3d5907c87c8b44f4f962600"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_842fba233d89f76938fdcb1cd0"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_0768b1b477d6f9e590fc86aadd"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_4443a0125e443faf35976c0d07"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_febfac3b7bf38da9b119fa050a"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_6e2b6bf8bb5605165c05fc9a71"`);
        await queryRunner.query(`DROP TABLE "insurance_renewals"`);
        await queryRunner.query(`DROP TYPE "public"."insurance_renewals_status_enum"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_cb231129fd839fedfd64b36b0b"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_58b6d392b802763fda1b8cdd21"`);
        ...
        await queryRunner.query(`DROP TYPE "public"."insurance_claims_priority_enum"`);
        await queryRunner.query(`DROP TYPE "public"."insurance_claims_status_enum"`);
        await queryRunner.query(`DROP TYPE "public"."insurance_claims_claimtype_enum"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_ad5fa6719b3f85494d88af4a40"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_797841712968aa775af0cb0b54"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_13c6c844995d9cc303e7e05087"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_db8d3f73a58b39fc0c14302840"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_1943870d1428ea81b65bc8da7b"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_ab221329a9f4c2111690d52f34"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_308682392d14d98044e5b83ce0"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_3cdb9a8e7d235c139d64966279"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_1e1c07d344e91d59d80214fa1b"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_2a553e06185295514ff6639a24"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_8a9c3a4224d38b3efa4d6d1ee5"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_0713a9b6c88a666629a6b9124e"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_3cdb9a8e7d235c139d64966279"`);
        await queryRunner.query(`DROP TABLE "price_suggestions"`);
        await queryRunner.query(`DROP TYPE "public"."price_suggestions_status_enum"`);
        await queryRunner.query(`DROP TYPE "public"."price_suggestions_confidencelevel_enum"`);
        await queryRunner.query(`DROP TYPE "public"."price_suggestions_pricingmodel_enum"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_6d53c760355b9723023759f004"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_a409b6270ed1bfc522ab31d898"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_c8c82b37aeb9e8533d1d8cc47e"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_d62b1710396e4e118bdc877e5f"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_c6bd59f488e37653f66b02599f"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_a409b6270ed1bfc522ab31d898"`);
        await queryRunner.query(`DROP TABLE "tracking_events"`);
        await queryRunner.query(`DROP TYPE "public"."tracking_events_geofencetype_enum"`);
        await queryRunner.query(`DROP TYPE "public"."tracking_events_type_enum"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_47c934ba14c7f8893184544f86"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_baea09a6daa36c25bc1f321699"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_0ab497cdb0d3e2da3b58f5f704"`);
        ...
        await queryRunner.query(`DROP TYPE "public"."user_ratings_ratingtype_enum"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_019a1bfe83abbfab615a3c3ef9"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_a81d93c5706529dad43990e4a3"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_e7bddc41671772b45a3d803db9"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_61c9fa9c7fa4eddb9dbad3d09d"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_4bf0030a3bc50c87ee9d62150a"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_5636b0881461b62c4784c63c2d"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_18c0c8ba52eb33c51ecc2a3eaf"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_a53c7fe240b4a67cce9053625e"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_2147d38f116dcc1d8b49dbfb81"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_d488a84526d22ad2b799829b7d"`);
        ...
        await queryRunner.query(`DROP TYPE "public"."user_profiles_kycstatus_enum"`);
