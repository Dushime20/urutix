...
export class SchemaRecovery1770000000004 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        // Logistics & Messaging
        await queryRunner.query(`CREATE TABLE IF NOT EXISTS "maintenance_logs" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "truck_id" uuid NOT NULL, "tenant_id" uuid NOT NULL, "type" "public"."maintenance_logs_type_enum" NOT NULL DEFAULT 'ROUTINE', "status" "public"."maintenance_logs_status_enum" NOT NULL DEFAULT 'PENDING', "description" text, "cost" numeric(15,2), "date" date NOT NULL, "next_due_date" date, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_maintenance_logs_id" PRIMARY KEY ("id"))`);
