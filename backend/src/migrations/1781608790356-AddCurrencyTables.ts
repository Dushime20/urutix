...
export class AddCurrencyTables1781608790356 implements MigrationInterface {
    name = 'AddCurrencyTables1781608790356'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "user_profiles" DROP CONSTRAINT "FK_6ca9503d77ae39b4b5a6cc3ba88"`);
        await queryRunner.query(`ALTER TABLE "tenants" DROP CONSTRAINT "tenants_kyc_reviewed_by_fkey"`);
        await queryRunner.query(`ALTER TABLE "user_sessions" DROP CONSTRAINT "fk_user_sessions_tenant"`);
        await queryRunner.query(`ALTER TABLE "user_sessions" DROP CONSTRAINT "user_sessions_user_id_fkey"`);
        await queryRunner.query(`ALTER TABLE "subscription_plans" DROP CONSTRAINT "subscription_plans_parent_subscription_id_fkey"`);
        await queryRunner.query(`ALTER TABLE "subscription_payments" DROP CONSTRAINT "subscription_payments_subscription_id_fkey"`);
        await queryRunner.query(`ALTER TABLE "credit_accounts" DROP CONSTRAINT "credit_accounts_tenant_id_fkey"`);
        await queryRunner.query(`ALTER TABLE "credit_accounts" DROP CONSTRAINT "fk_credit_accounts_user"`);
        await queryRunner.query(`ALTER TABLE "credit_transactions" DROP CONSTRAINT "credit_transactions_tenant_id_fkey"`);
        await queryRunner.query(`ALTER TABLE "credit_transactions" DROP CONSTRAINT "credit_transactions_subscription_id_fkey"`);
        await queryRunner.query(`ALTER TABLE "credit_transactions" DROP CONSTRAINT "credit_transactions_credit_account_id_fkey"`);
        await queryRunner.query(`ALTER TABLE "credit_transactions" DROP CONSTRAINT "fk_credit_transactions_user_id"`);
        await queryRunner.query(`ALTER TABLE "tenant_subscriptions" DROP CONSTRAINT "tenant_subscriptions_plan_id_fkey"`);
        await queryRunner.query(`ALTER TABLE "tenant_subscriptions" DROP CONSTRAINT "tenant_subscriptions_tenant_id_fkey"`);
        await queryRunner.query(`ALTER TABLE "tenant_subscriptions" DROP CONSTRAINT "fk_tenant_subscriptions_user"`);
        await queryRunner.query(`ALTER TABLE "tenant_kyc_documents" DROP CONSTRAINT "tenant_kyc_documents_verified_by_fkey"`);
        await queryRunner.query(`ALTER TABLE "tenant_kyc_documents" DROP CONSTRAINT "tenant_kyc_documents_uploaded_by_fkey"`);
        await queryRunner.query(`ALTER TABLE "tenant_kyc_documents" DROP CONSTRAINT "tenant_kyc_documents_tenant_id_fkey"`);
        await queryRunner.query(`ALTER TABLE "tenant_kyc_audit_log" DROP CONSTRAINT "tenant_kyc_audit_log_performed_by_fkey"`);
        await queryRunner.query(`ALTER TABLE "tenant_kyc_audit_log" DROP CONSTRAINT "tenant_kyc_audit_log_tenant_id_fkey"`);
        await queryRunner.query(`ALTER TABLE "system_settings" DROP CONSTRAINT "FK_system_settings_updated_by"`);
        await queryRunner.query(`ALTER TABLE "security_events" DROP CONSTRAINT "fk_security_events_tenant"`);
        await queryRunner.query(`ALTER TABLE "security_events" DROP CONSTRAINT "security_events_user_id_fkey"`);
        ...
        await queryRunner.query(`ALTER TABLE "loan_terms" DROP CONSTRAINT "FK_loan_terms_loan_request"`);
        await queryRunner.query(`ALTER TABLE "lending_policy_system_config" DROP CONSTRAINT "lending_policy_system_config_lender_id_fkey"`);
        await queryRunner.query(`ALTER TABLE "lending_policy_risk_assessment" DROP CONSTRAINT "lending_policy_risk_assessment_lender_id_fkey"`);
        await queryRunner.query(`ALTER TABLE "lending_policy_repayment" DROP CONSTRAINT "lending_policy_repayment_lender_id_fkey"`);
        await queryRunner.query(`ALTER TABLE "lending_policy_loan_limits" DROP CONSTRAINT "lending_policy_loan_limits_lender_id_fkey"`);
        await queryRunner.query(`ALTER TABLE "lending_policy_interest_rates" DROP CONSTRAINT "lending_policy_interest_rates_lender_id_fkey"`);
        await queryRunner.query(`ALTER TABLE "lending_policy_eligibility_criteria" DROP CONSTRAINT "lending_policy_eligibility_criteria_lender_id_fkey"`);
        await queryRunner.query(`ALTER TABLE "lending_policy_cargo_types" DROP CONSTRAINT "lending_policy_cargo_types_lender_id_fkey"`);
        await queryRunner.query(`ALTER TABLE "insurance_verifications" DROP CONSTRAINT "FK_insurance_verifications_tenant"`);
        await queryRunner.query(`ALTER TABLE "insurance_verifications" DROP CONSTRAINT "FK_insurance_verifications_load"`);
        await queryRunner.query(`ALTER TABLE "insurance_verifications" DROP CONSTRAINT "FK_insurance_verifications_transporter"`);
        await queryRunner.query(`ALTER TABLE "insurance_verifications" DROP CONSTRAINT "FK_insurance_verifications_broker"`);
        ...
        await queryRunner.query(`ALTER TABLE "fuel_wallet_transactions" DROP CONSTRAINT "fuel_wallet_transactions_wallet_id_fkey"`);
        await queryRunner.query(`ALTER TABLE "escrow_accounts" DROP CONSTRAINT "FK_escrow_accounts_tenant"`);
        await queryRunner.query(`ALTER TABLE "escrow_accounts" DROP CONSTRAINT "FK_escrow_accounts_trip"`);
        await queryRunner.query(`ALTER TABLE "escrow_accounts" DROP CONSTRAINT "FK_escrow_accounts_load"`);
        await queryRunner.query(`ALTER TABLE "escrow_accounts" DROP CONSTRAINT "FK_escrow_accounts_payee"`);
        await queryRunner.query(`ALTER TABLE "escrow_accounts" DROP CONSTRAINT "FK_escrow_accounts_payer"`);
        await queryRunner.query(`ALTER TABLE "escrow_accounts" DROP CONSTRAINT "FK_escrow_accounts_broker"`);
        await queryRunner.query(`ALTER TABLE "email_templates" DROP CONSTRAINT "email_templates_updated_by_fkey"`);
        await queryRunner.query(`ALTER TABLE "email_templates" DROP CONSTRAINT "email_templates_created_by_fkey"`);
        await queryRunner.query(`ALTER TABLE "credit_pricing_rules" DROP CONSTRAINT "credit_pricing_rules_tenant_id_fkey"`);
        await queryRunner.query(`ALTER TABLE "credit_pricing_rules" DROP CONSTRAINT "credit_pricing_rules_plan_id_fkey"`);
        await queryRunner.query(`ALTER TABLE "credit_marketplace_settings" DROP CONSTRAINT "credit_marketplace_settings_tenant_admin_user_id_fkey"`);
        await queryRunner.query(`ALTER TABLE "credit_marketplace_settings" DROP CONSTRAINT "credit_marketplace_settings_tenant_id_fkey"`);
        await queryRunner.query(`ALTER TABLE "bulk_email_logs" DROP CONSTRAINT "bulk_email_logs_created_by_fkey"`);
        await queryRunner.query(`ALTER TABLE "bulk_email_logs" DROP CONSTRAINT "bulk_email_logs_template_id_fkey"`);
        await queryRunner.query(`ALTER TABLE "bulk_email_logs" DROP CONSTRAINT "bulk_email_logs_tenant_id_fkey"`);
        await queryRunner.query(`ALTER TABLE "broker_disputes" DROP CONSTRAINT "FK_broker_disputes_tenant"`);
        await queryRunner.query(`ALTER TABLE "broker_disputes" DROP CONSTRAINT "FK_broker_disputes_trip"`);
        await queryRunner.query(`ALTER TABLE "broker_disputes" DROP CONSTRAINT "FK_broker_disputes_load"`);
        await queryRunner.query(`ALTER TABLE "broker_disputes" DROP CONSTRAINT "FK_broker_disputes_mediator"`);
        await queryRunner.query(`ALTER TABLE "broker_disputes" DROP CONSTRAINT "FK_broker_disputes_disputed_with"`);
        await queryRunner.query(`ALTER TABLE "broker_disputes" DROP CONSTRAINT "FK_broker_disputes_raised_by"`);
        await queryRunner.query(`ALTER TABLE "broker_disputes" DROP CONSTRAINT "FK_broker_disputes_broker"`);
        ...
        await queryRunner.query(`ALTER TABLE "role_permissions" DROP CONSTRAINT "role_permissions_granted_by_fkey"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_user_profiles_kyc_requirement_level"`);
        await queryRunner.query(`DROP INDEX "public"."idx_tenants_onboarding_step"`);
        await queryRunner.query(`DROP INDEX "public"."idx_tenants_kyc_status"`);
        await queryRunner.query(`DROP INDEX "public"."idx_tenants_kyc_submitted_at"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_users_tenant_email_role"`);
        await queryRunner.query(`DROP INDEX "public"."idx_user_sessions_user_id"`);
        await queryRunner.query(`DROP INDEX "public"."idx_user_sessions_tenant_id"`);
        await queryRunner.query(`DROP INDEX "public"."idx_user_sessions_expires_at"`);
        await queryRunner.query(`DROP INDEX "public"."idx_user_sessions_last_activity"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."idx_subscription_plans_slug"`);
        await queryRunner.query(`DROP INDEX "public"."idx_subscription_plans_active"`);
        await queryRunner.query(`DROP INDEX "public"."idx_subscription_plans_price_per_credit"`);
        await queryRunner.query(`DROP INDEX "public"."idx_subscription_plans_credits_per_ton"`);
        await queryRunner.query(`DROP INDEX "public"."idx_subscription_plans_parent_subscription_id"`);
        await queryRunner.query(`DROP INDEX "public"."idx_subscription_payments_subscription"`);
        await queryRunner.query(`DROP INDEX "public"."idx_subscription_payments_payment"`);
        await queryRunner.query(`DROP INDEX "public"."idx_subscription_payments_invoice"`);
        await queryRunner.query(`DROP INDEX "public"."idx_credit_accounts_tenant"`);
        await queryRunner.query(`DROP INDEX "public"."idx_credit_accounts_balance"`);
        await queryRunner.query(`DROP INDEX "public"."idx_credit_accounts_refresh"`);
        await queryRunner.query(`DROP INDEX "public"."idx_credit_accounts_user_id"`);
        await queryRunner.query(`DROP INDEX "public"."idx_credit_accounts_tenant_user"`);
        await queryRunner.query(`DROP INDEX "public"."idx_credit_accounts_revenue"`);
        await queryRunner.query(`DROP INDEX "public"."idx_credit_accounts_partners_sold"`);
        await queryRunner.query(`DROP INDEX "public"."idx_credit_transactions_tenant"`);
        await queryRunner.query(`DROP INDEX "public"."idx_credit_transactions_account"`);
        await queryRunner.query(`DROP INDEX "public"."idx_credit_transactions_type"`);
        await queryRunner.query(`DROP INDEX "public"."idx_credit_transactions_reference"`);
        await queryRunner.query(`DROP INDEX "public"."idx_credit_transactions_user_id"`);
        await queryRunner.query(`DROP INDEX "public"."idx_tenant_subscriptions_tenant"`);
        await queryRunner.query(`DROP INDEX "public"."idx_tenant_subscriptions_status"`);
        await queryRunner.query(`DROP INDEX "public"."idx_tenant_subscriptions_period"`);
        await queryRunner.query(`DROP INDEX "public"."idx_tenant_subscriptions_user_id"`);
        await queryRunner.query(`DROP INDEX "public"."idx_tenant_kyc_documents_tenant_id"`);
        await queryRunner.query(`DROP INDEX "public"."idx_tenant_kyc_documents_type"`);
        await queryRunner.query(`DROP INDEX "public"."idx_tenant_kyc_documents_verified"`);
        await queryRunner.query(`DROP INDEX "public"."idx_tenant_kyc_audit_log_tenant_id"`);
        await queryRunner.query(`DROP INDEX "public"."idx_tenant_kyc_audit_log_created_at"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_system_settings_category"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_system_settings_is_public"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_system_health_logs_service"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_system_health_logs_timestamp"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_system_health_logs_status"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_system_health_logs_service_timestamp"`);
        await queryRunner.query(`DROP INDEX "public"."idx_system_health_timestamp"`);
        await queryRunner.query(`DROP INDEX "public"."idx_system_health_service_timestamp"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."idx_security_events_user_id"`);
        await queryRunner.query(`DROP INDEX "public"."idx_security_events_tenant_id"`);
        await queryRunner.query(`DROP INDEX "public"."idx_security_events_event_type"`);
        await queryRunner.query(`DROP INDEX "public"."idx_security_events_severity_created"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."idx_messages_sender_recipient"`);
        await queryRunner.query(`DROP INDEX "public"."idx_messages_thread_id"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."idx_messages_tenant_id"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_messages_sender_recipient"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_messages_thread_id"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_messages_created_at"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_messages_is_read"`);
        await queryRunner.query(`DROP INDEX "public"."idx_ml_tenant_truck"`);
        await queryRunner.query(`DROP INDEX "public"."idx_ml_truck_status"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_loan_terms_lender_id_computed_at"`);
        await queryRunner.query(`DROP INDEX "public"."idx_system_config_lender"`);
        await queryRunner.query(`DROP INDEX "public"."idx_lpsc_lender_id"`);
        await queryRunner.query(`DROP INDEX "public"."idx_risk_assessment_lender"`);
        await queryRunner.query(`DROP INDEX "public"."idx_lpra_lender_active"`);
        await queryRunner.query(`DROP INDEX "public"."idx_lpra_factor_active"`);
        await queryRunner.query(`DROP INDEX "public"."idx_repayment_lender"`);
        await queryRunner.query(`DROP INDEX "public"."idx_lpr_lender_active"`);
        await queryRunner.query(`DROP INDEX "public"."idx_lpr_frequency_active"`);
        await queryRunner.query(`DROP INDEX "public"."idx_loan_limits_lender"`);
        await queryRunner.query(`DROP INDEX "public"."idx_loan_limits_business_type"`);
        await queryRunner.query(`DROP INDEX "public"."idx_lpll_lender_active"`);
        await queryRunner.query(`DROP INDEX "public"."idx_lpll_business_type_active"`);
        await queryRunner.query(`DROP INDEX "public"."idx_interest_rates_lender"`);
        await queryRunner.query(`DROP INDEX "public"."idx_interest_rates_active"`);
        await queryRunner.query(`DROP INDEX "public"."idx_lpir_lender_active"`);
        await queryRunner.query(`DROP INDEX "public"."idx_lpir_risk_active"`);
        await queryRunner.query(`DROP INDEX "public"."idx_lpec_lender_active"`);
        await queryRunner.query(`DROP INDEX "public"."idx_lpec_category_active"`);
        await queryRunner.query(`DROP INDEX "public"."idx_cargo_types_lender"`);
        await queryRunner.query(`DROP INDEX "public"."idx_cargo_types_cargo_type"`);
        await queryRunner.query(`DROP INDEX "public"."idx_lpct_lender_active"`);
        await queryRunner.query(`DROP INDEX "public"."idx_lpct_cargo_category_active"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_insurance_verifications_transporter_status"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_insurance_verifications_load_type"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_insurance_verifications_tenant_created"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."idx_fw_tenant_owner"`);
        await queryRunner.query(`DROP INDEX "public"."idx_fw_tenant_driver"`);
        await queryRunner.query(`DROP INDEX "public"."idx_fwt_wallet"`);
        await queryRunner.query(`DROP INDEX "public"."idx_feature_credit_costs_code"`);
        await queryRunner.query(`DROP INDEX "public"."idx_feature_credit_costs_active"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_escrow_accounts_load_status"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_escrow_accounts_trip_status"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_escrow_accounts_tenant_created"`);
        await queryRunner.query(`DROP INDEX "public"."idx_email_templates_category"`);
        await queryRunner.query(`DROP INDEX "public"."idx_email_templates_active"`);
        await queryRunner.query(`DROP INDEX "public"."idx_email_templates_name"`);
        await queryRunner.query(`DROP INDEX "public"."idx_dfa_tenant_driver"`);
        await queryRunner.query(`DROP INDEX "public"."idx_dfa_tenant_trip"`);
        await queryRunner.query(`DROP INDEX "public"."idx_dfa_tenant_status"`);
        await queryRunner.query(`DROP INDEX "public"."idx_pricing_rules_type"`);
        await queryRunner.query(`DROP INDEX "public"."idx_pricing_rules_plan"`);
        await queryRunner.query(`DROP INDEX "public"."idx_pricing_rules_tenant"`);
        await queryRunner.query(`DROP INDEX "public"."idx_pricing_rules_priority"`);
        await queryRunner.query(`DROP INDEX "public"."idx_credit_packages_active"`);
        await queryRunner.query(`DROP INDEX "public"."idx_credit_packages_slug"`);
        await queryRunner.query(`DROP INDEX "public"."idx_marketplace_tenant"`);
        await queryRunner.query(`DROP INDEX "public"."idx_marketplace_enabled"`);
        await queryRunner.query(`DROP INDEX "public"."idx_bulk_email_logs_tenant"`);
        await queryRunner.query(`DROP INDEX "public"."idx_bulk_email_logs_template"`);
        await queryRunner.query(`DROP INDEX "public"."idx_bulk_email_logs_status"`);
        await queryRunner.query(`DROP INDEX "public"."idx_bulk_email_logs_created_at"`);
        await queryRunner.query(`DROP INDEX "public"."idx_bulk_email_logs_created_by"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_broker_disputes_broker_status"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_broker_disputes_load_status"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_broker_disputes_trip_status"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_broker_disputes_tenant_created"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_broker_match_recommendations_broker_load"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_broker_match_recommendations_broker_status"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_broker_match_recommendations_transporter_status"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_broker_market_intelligence_broker_route"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_broker_market_intelligence_broker_created"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_broker_market_intelligence_route_type"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_broker_transporter_credit_broker_transporter"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_broker_transporter_credit_transporter_status"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_broker_multi_stop_loads_broker_load"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_broker_transporter_performance_broker_transporter"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_broker_transporter_performance_transporter_calculated"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."idx_activity_logs_suspicious"`);
        await queryRunner.query(`DROP INDEX "public"."idx_activity_logs_security_relevant"`);
        await queryRunner.query(`DROP INDEX "public"."idx_activity_logs_security_created"`);
        ...
        await queryRunner.query(`ALTER TABLE "credit_accounts" DROP CONSTRAINT "chk_positive_balance"`);
        await queryRunner.query(`ALTER TABLE "credit_accounts" DROP CONSTRAINT "chk_positive_subscription_credits"`);
        await queryRunner.query(`ALTER TABLE "credit_accounts" DROP CONSTRAINT "chk_positive_purchased_credits"`);
        await queryRunner.query(`ALTER TABLE "credit_accounts" DROP CONSTRAINT "chk_positive_bonus_credits"`);
        await queryRunner.query(`ALTER TABLE "credit_transactions" DROP CONSTRAINT "chk_transaction_type"`);
        await queryRunner.query(`ALTER TABLE "tenant_subscriptions" DROP CONSTRAINT "chk_subscription_status"`);
        await queryRunner.query(`ALTER TABLE "tenant_subscriptions" DROP CONSTRAINT "chk_billing_cycle"`);
        await queryRunner.query(`ALTER TABLE "feature_credit_costs" DROP CONSTRAINT "chk_positive_cost"`);
        await queryRunner.query(`ALTER TABLE "credit_pricing_rules" DROP CONSTRAINT "chk_positive_cost"`);
        await queryRunner.query(`ALTER TABLE "credit_pricing_rules" DROP CONSTRAINT "chk_valid_rule_type"`);
        await queryRunner.query(`ALTER TABLE "credit_packages" DROP CONSTRAINT "chk_positive_credits"`);
        await queryRunner.query(`ALTER TABLE "credit_packages" DROP CONSTRAINT "chk_positive_price"`);
        await queryRunner.query(`ALTER TABLE "credit_packages" DROP CONSTRAINT "chk_valid_discount"`);
        await queryRunner.query(`ALTER TABLE "credit_marketplace_settings" DROP CONSTRAINT "positive_min_purchase"`);
        await queryRunner.query(`ALTER TABLE "credit_marketplace_settings" DROP CONSTRAINT "positive_max_purchase"`);
        await queryRunner.query(`ALTER TABLE "credit_marketplace_settings" DROP CONSTRAINT "max_greater_than_min"`);
        await queryRunner.query(`ALTER TABLE "credit_marketplace_settings" DROP CONSTRAINT "positive_price"`);
        await queryRunner.query(`ALTER TABLE "permissions" DROP CONSTRAINT "permissions_resource_action_key"`);
        await queryRunner.query(`ALTER TABLE "credit_accounts" DROP CONSTRAINT "uq_credit_accounts_tenant_user"`);
        await queryRunner.query(`ALTER TABLE "system_settings" DROP CONSTRAINT "UQ_system_settings_category_key"`);
        await queryRunner.query(`ALTER TABLE "role_permissions" DROP CONSTRAINT "role_permissions_role_permission_id_key"`);
        ...
        await queryRunner.query(`CREATE TABLE "webhook_configs" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "tenantId" uuid NOT NULL, "createdBy" uuid NOT NULL, "name" character varying NOT NULL, "url" character varying NOT NULL, "events" text NOT NULL, "secret" character varying(64), "isActive" boolean NOT NULL DEFAULT true, "lastDeliveredAt" TIMESTAMP, "failureCount" integer NOT NULL DEFAULT '0', "deliveryLogs" jsonb NOT NULL DEFAULT '[]', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_b6d2d3606e01c28d476122185b6" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_09b6bf4f7d311a8f7192c4ee0c" ON "webhook_configs" ("tenantId", "isActive") `);
        await queryRunner.query(`CREATE TYPE "public"."epods_status_enum" AS ENUM('PENDING', 'CONFIRMED', 'DISPUTED')`);
        await queryRunner.query(`CREATE TABLE "epods" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "tenantId" uuid NOT NULL, "tripId" uuid NOT NULL, "driverId" uuid NOT NULL, "cargoOwnerId" uuid NOT NULL, "recipientName" character varying(200) NOT NULL, "recipientPhone" character varying, "signatureFileUrl" character varying, "photoUrls" jsonb NOT NULL DEFAULT '[]', "deliveryNotes" character varying, "odometerReading" character varying, "deliveryAddress" character varying, "deliveryCoordinates" jsonb, "status" "public"."epods_status_enum" NOT NULL DEFAULT 'PENDING', "submittedAt" TIMESTAMP WITH TIME ZONE NOT NULL, "confirmedAt" TIMESTAMP WITH TIME ZONE, "disputedAt" TIMESTAMP WITH TIME ZONE, "disputeReason" text, "invoiceId" uuid, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "REL_d91caab5b970b8866f63765d30" UNIQUE ("tripId"), CONSTRAINT "PK_21d1d33cf386c1d7c662fe38256" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "revenue_records" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "tripId" uuid NOT NULL, "loadId" uuid NOT NULL, "tenantId" uuid NOT NULL, "brokerId" uuid, "grossAmount" numeric(15,2) NOT NULL, "platformFeeRate" numeric(5,4) NOT NULL DEFAULT '0.05', "platformFeeAmount" numeric(15,2) NOT NULL, "brokerCommissionAmount" numeric(15,2) NOT NULL DEFAULT '0', "netPayoutAmount" numeric(15,2) NOT NULL, "currency" character varying(10) NOT NULL DEFAULT 'KES', "isSettled" boolean NOT NULL DEFAULT false, "settledAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_aff9bdee400e24db3bb89cfd23e" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_2fd40f6797a523eaf0f85e7aee" ON "revenue_records" ("tripId") `);
        await queryRunner.query(`CREATE INDEX "IDX_c6b16825957aaaae73864ef1fc" ON "revenue_records" ("tenantId", "settledAt") `);
        await queryRunner.query(`CREATE TABLE "private_carrier_networks" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "cargoOwnerId" uuid NOT NULL, "truckOwnerId" uuid NOT NULL, "tenantId" uuid NOT NULL, "notes" text, "isActive" boolean NOT NULL DEFAULT true, "addedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_eb32fa4a9e00e199edf641aeed5" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_2cc379d4395eaeedab6b740e39" ON "private_carrier_networks" ("cargoOwnerId", "tenantId") `);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_89cf3cc132d3dbc4f57818600d" ON "private_carrier_networks" ("cargoOwnerId", "truckOwnerId", "tenantId") `);
        ...
        await queryRunner.query(`CREATE TYPE "public"."kyc_role_requirements_role_enum" AS ENUM('SUPER_ADMIN', 'ADMIN', 'TENANT_ADMIN', 'CARGO_OWNER', 'CARGO_RECEIVER', 'TRUCK_OWNER', 'DRIVER', 'AGENT', 'LENDER', 'BROKER', 'FLEET_MANAGER', 'FLEET_DISPATCHER', 'FLEET_ACCOUNTANT', 'FLEET_SAFETY_OFFICER', 'CUSTOMS_OFFICER')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."geofence_zones_type_enum" AS ENUM('DELIVERY_ZONE', 'RESTRICTED', 'CUSTOMER_SITE', 'DEPOT', 'CHECKPOINT')`);
        await queryRunner.query(`CREATE TABLE "geofence_zones" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "tenantId" uuid NOT NULL, "name" character varying NOT NULL, "type" "public"."geofence_zones_type_enum" NOT NULL DEFAULT 'DELIVERY_ZONE', "polygon" jsonb NOT NULL, "centerLat" numeric(10,7), "centerLng" numeric(10,7), "radiusMeters" numeric(10,2), "alertOnEnter" boolean NOT NULL DEFAULT true, "alertOnExit" boolean NOT NULL DEFAULT true, "linkedLoadId" uuid, "isActive" boolean NOT NULL DEFAULT true, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_ea4a1d9e1ff81eee336b4e8d071" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_abeb7de67b5ba7dff9860545b6" ON "geofence_zones" ("tenantId", "isActive") `);
        ...
        await queryRunner.query(`CREATE TABLE "exchange_rates" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "baseCurrency" character varying(3) NOT NULL DEFAULT 'USD', "targetCurrency" character varying(3) NOT NULL, "rate" numeric(20,8) NOT NULL, "source" character varying, "fetched_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_33a614bad9e61956079d817ebe2" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_ce280779f3149fad2149bf910a" ON "exchange_rates" ("fetched_at") `);
        await queryRunner.query(`CREATE INDEX "IDX_9f3d031a4792835a4acee284c5" ON "exchange_rates" ("baseCurrency", "targetCurrency") `);
        await queryRunner.query(`CREATE TYPE "public"."customs_inspections_status_enum" AS ENUM('PENDING', 'IN_PROGRESS', 'CLEARED', 'REJECTED', 'ON_HOLD', 'HIGH_RISK')`);
        await queryRunner.query(`CREATE TYPE "public"."customs_inspections_risklevel_enum" AS ENUM('LOW', 'MEDIUM', 'HIGH', 'CRITICAL')`);
        await queryRunner.query(`CREATE TYPE "public"."customs_inspections_inspectionchannel_enum" AS ENUM('GREEN', 'YELLOW', 'RED')`);
        await queryRunner.query(`CREATE TYPE "public"."customs_inspections_examtype_enum" AS ENUM('NONE', 'DOCUMENT', 'X_RAY', 'TAILGATE', 'INTENSIVE')`);
        await queryRunner.query(`CREATE TYPE "public"."customs_inspections_holdtype_enum" AS ENUM('NONE', 'MANIFEST', 'STATISTICAL', 'COMMERCIAL_ENFORCEMENT', 'ANTI_TERRORISM', 'AGENCY', 'SANCTIONS', 'DANGEROUS_GOODS', 'DUTY_ARREARS')`);
        await queryRunner.query(`CREATE TABLE "customs_inspections" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "tenantId" uuid NOT NULL, "officerId" uuid NOT NULL, "tripId" uuid, "plateNumber" character varying, "containerNumber" character varying, "shipmentReference" character varying, "driverName" character varying, "driverId" character varying, "truckType" character varying, "originCountry" character varying, "destinationCountry" character varying, "cargoType" character varying, "cargoCategory" character varying, "declaredWeight" numeric(10,2), "actualWeight" numeric(10,2), "declaredQuantity" integer, "actualQuantity" integer, "hsCode" character varying, "sealNumber" character varying, "shippingCompany" character varying, "declarationNumber" character varying, "countryOfOrigin" character varying, "modeOfTransport" character varying, "imdgClass" character varying, "unNumber" character varying, "declaredValue" numeric(15,2), "currency" character varying DEFAULT 'USD', "dutyAmount" numeric(15,2), "taxAmount" numeric(15,2), "aeoNumber" character varying, "deniedPartyFlag" boolean NOT NULL DEFAULT false, "sanctionsScreened" boolean NOT NULL DEFAULT false, "hasDangerousGoods" boolean NOT NULL DEFAULT false, "isRestrictedGoods" boolean NOT NULL DEFAULT false, "status" "public"."customs_inspections_status_enum" NOT NULL DEFAULT 'PENDING', "riskLevel" "public"."customs_inspections_risklevel_enum" NOT NULL DEFAULT 'LOW', "inspectionChannel" "public"."customs_inspections_inspectionchannel_enum", "examType" "public"."customs_inspections_examtype_enum" NOT NULL DEFAULT 'NONE', "holdType" "public"."customs_inspections_holdtype_enum" NOT NULL DEFAULT 'NONE', "estimatedReleaseAt" TIMESTAMP, "checkpointId" character varying, "checkpointName" character varying, "inspectionNotes" text, "rejectionReason" text, "documentsVerified" jsonb, "evidenceUrls" text, "metadata" jsonb, "completedAt" TIMESTAMP, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_8984f033fd191ef7912eb5de09e" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_536dc50e6fb907218efee3f223" ON "customs_inspections" ("createdAt") `);
        await queryRunner.query(`CREATE INDEX "IDX_02cd4dc58d3e19f91e5c76f588" ON "customs_inspections" ("shipmentReference") `);
        await queryRunner.query(`CREATE INDEX "IDX_13fc32060c7bb57af14bedebb8" ON "customs_inspections" ("plateNumber") `);
        await queryRunner.query(`CREATE INDEX "IDX_0e96a836c8168d21369bf49d17" ON "customs_inspections" ("tenantId", "officerId") `);
        await queryRunner.query(`CREATE INDEX "IDX_e1677825b2bc4a6d8e579b9e53" ON "customs_inspections" ("tenantId", "status") `);
        await queryRunner.query(`CREATE TYPE "public"."customs_compliance_responses_status_enum" AS ENUM('SUBMITTED', 'REVIEWED', 'ACCEPTED', 'REJECTED')`);
        await queryRunner.query(`CREATE TABLE "customs_compliance_responses" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "inspectionId" uuid NOT NULL, "submittedById" uuid NOT NULL, "notes" text NOT NULL, "documentIds" jsonb NOT NULL DEFAULT '[]', "status" "public"."customs_compliance_responses_status_enum" NOT NULL DEFAULT 'SUBMITTED', "reviewedById" uuid, "reviewNotes" text, "reviewedAt" TIMESTAMP, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_c4192488a0fbd7b3974beb16514" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_40d2ede4cf9edc8fd065c89d49" ON "customs_compliance_responses" ("status") `);
        await queryRunner.query(`CREATE INDEX "IDX_6763bfee5af4c2fdfc1e86f303" ON "customs_compliance_responses" ("submittedById") `);
        await queryRunner.query(`CREATE INDEX "IDX_f93160727f0dc81c051fa139fd" ON "customs_compliance_responses" ("inspectionId") `);
        await queryRunner.query(`CREATE TYPE "public"."customs_checkpoints_type_enum" AS ENUM('BORDER', 'PORT', 'WAREHOUSE', 'INLAND', 'AIRPORT')`);
        await queryRunner.query(`CREATE TABLE "customs_checkpoints" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "tenantId" uuid NOT NULL, "name" character varying NOT NULL, "code" character varying, "type" "public"."customs_checkpoints_type_enum" NOT NULL DEFAULT 'BORDER', "country" character varying, "city" character varying, "address" character varying, "latitude" numeric(10,7), "longitude" numeric(10,7), "isActive" boolean NOT NULL DEFAULT true, "metadata" jsonb, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_2ba759370e402dfcc5a04c398eb" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_a112819bd3e30e139f6fb175f0" ON "customs_checkpoints" ("isActive") `);
        await queryRunner.query(`CREATE INDEX "IDX_2f1f1bdb5046fa5c43cbfeb23b" ON "customs_checkpoints" ("tenantId") `);
        await queryRunner.query(`CREATE TABLE "currencies" ("code" character varying(3) NOT NULL, "name" character varying(64) NOT NULL, "symbol" character varying(16) NOT NULL, "locale" character varying(16) NOT NULL, "decimals" integer NOT NULL DEFAULT '2', "flag" character varying(8) NOT NULL DEFAULT '🏳', "isActive" boolean NOT NULL DEFAULT true, "manualRate" numeric(20,8), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_9f8d0972aeeb5a2277e40332d29" PRIMARY KEY ("code"))`);
        await queryRunner.query(`CREATE TYPE "public"."carrier_tiers_tier_enum" AS ENUM('BRONZE', 'SILVER', 'GOLD', 'PLATINUM')`);
        await queryRunner.query(`CREATE TYPE "public"."carrier_tiers_previoustier_enum" AS ENUM('BRONZE', 'SILVER', 'GOLD', 'PLATINUM')`);
        await queryRunner.query(`CREATE TABLE "carrier_tiers" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "truckOwnerId" uuid NOT NULL, "tenantId" uuid NOT NULL, "tier" "public"."carrier_tiers_tier_enum" NOT NULL DEFAULT 'BRONZE', "previousTier" "public"."carrier_tiers_previoustier_enum", "onTimeRate" numeric(5,2) NOT NULL DEFAULT '0', "damageRate" numeric(5,2) NOT NULL DEFAULT '0', "totalTrips" integer NOT NULL DEFAULT '0', "averageRating" numeric(5,2) NOT NULL DEFAULT '0', "calculatedAt" TIMESTAMP, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_05f3a19cec46fe0f397a90fd8db" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_9cf5dbea5c6f64eb8f48fe0506" ON "carrier_tiers" ("tier", "tenantId") `);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_ace05c8e81c471323d1dee4567" ON "carrier_tiers" ("truckOwnerId", "tenantId") `);
        ...
        await queryRunner.query(`CREATE TABLE "api_keys" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "tenantId" uuid NOT NULL, "createdBy" uuid NOT NULL, "name" character varying NOT NULL, "keyHash" character varying(64) NOT NULL, "keyPrefix" character varying(8) NOT NULL, "permissions" text NOT NULL DEFAULT '', "isActive" boolean NOT NULL DEFAULT true, "lastUsedAt" TIMESTAMP, "expiresAt" TIMESTAMP, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_5c8a79801b44bd27b79228e1dad" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_df3b25181df0b4b59bd93f16e1" ON "api_keys" ("keyHash") `);
        await queryRunner.query(`CREATE INDEX "IDX_e34700859a7a3bcc855808a0f7" ON "api_keys" ("tenantId", "isActive") `);
        ...
        await queryRunner.query(`ALTER TABLE "permissions" DROP CONSTRAINT "permissions_name_key"`);
        ...
        await queryRunner.query(`ALTER TABLE "credit_packages" DROP CONSTRAINT "credit_packages_slug_key"`);
        ...
        await queryRunner.query(`ALTER TABLE "auctions" ADD "targetPrice" numeric(15,2)`);
        await queryRunner.query(`ALTER TABLE "auctions" ADD "maxBudget" numeric(15,2)`);
        await queryRunner.query(`ALTER TABLE "auctions" ADD "startingPrice" numeric(15,2)`);
        await queryRunner.query(`ALTER TABLE "auctions" ADD "marketRate" numeric(15,2)`);
        await queryRunner.query(`ALTER TABLE "auctions" ADD "dropInterval" integer`);
        await queryRunner.query(`ALTER TABLE "auctions" ADD "dropAmount" numeric(15,2)`);
        await queryRunner.query(`ALTER TABLE "auctions" ADD "bidVisibility" character varying(50) DEFAULT 'HIDDEN'`);
        await queryRunner.query(`ALTER TABLE "auctions" ADD "allowBidRevision" boolean NOT NULL DEFAULT false`);
        await queryRunner.query(`ALTER TABLE "auctions" ADD "selectionCriteria" character varying(50) DEFAULT 'LOWEST_BID'`);
        await queryRunner.query(`ALTER TABLE "auctions" ADD "autoExtend" boolean NOT NULL DEFAULT false`);
        await queryRunner.query(`ALTER TABLE "auctions" ADD "minimumBidDecrement" numeric(15,2)`);
        ...
        await queryRunner.query(`ALTER TABLE "user_scores" ADD "tenantId" character varying`);
        await queryRunner.query(`ALTER TABLE "payments" ADD "payeeId" uuid`);
        ...
        await queryRunner.query(`ALTER TABLE "routes" ADD "origin_lat" numeric(10,7)`);
        await queryRunner.query(`ALTER TABLE "routes" ADD "origin_lng" numeric(10,7)`);
        await queryRunner.query(`ALTER TABLE "routes" ADD "origin_address" character varying(255)`);
        await queryRunner.query(`ALTER TABLE "routes" ADD "destination_lat" numeric(10,7)`);
        await queryRunner.query(`ALTER TABLE "routes" ADD "destination_lng" numeric(10,7)`);
        await queryRunner.query(`ALTER TABLE "routes" ADD "destination_address" character varying(255)`);
        ...
        await queryRunner.query(`ALTER TABLE "loan_requests" ADD "loan_number" character varying(50)`);
        await queryRunner.query(`ALTER TABLE "loan_requests" ADD CONSTRAINT "UQ_4382ec13ee491f4b516b8549d26" UNIQUE ("loan_number")`);
        await queryRunner.query(`ALTER TABLE "loan_requests" ADD "purpose" character varying(100)`);
        await queryRunner.query(`ALTER TABLE "loan_requests" ADD "kyc_verified" boolean NOT NULL DEFAULT false`);
        await queryRunner.query(`ALTER TABLE "loan_requests" ADD "currency" character varying(3) NOT NULL DEFAULT 'RWF'`);
        await queryRunner.query(`ALTER TABLE "loan_requests" ADD "origination_fee_rate" numeric(5,4)`);
        await queryRunner.query(`ALTER TABLE "loan_requests" ADD "origination_fee_amount" numeric(15,2)`);
        await queryRunner.query(`ALTER TABLE "loan_requests" ADD "total_cost_of_credit" numeric(15,2)`);
        await queryRunner.query(`ALTER TABLE "loan_requests" ADD "apr" numeric(7,4)`);
        await queryRunner.query(`ALTER TABLE "loan_requests" ADD "collateral_description" character varying(500)`);
        await queryRunner.query(`ALTER TABLE "loan_requests" ADD "collateral_value" numeric(15,2)`);
        await queryRunner.query(`ALTER TABLE "loan_requests" ADD "ltv_ratio" numeric(5,4)`);
        await queryRunner.query(`ALTER TABLE "loan_requests" ADD "grace_period_end" date`);
        await queryRunner.query(`ALTER TABLE "loan_requests" ADD "days_past_due" integer NOT NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE "loan_requests" ADD "ifrs9_stage" integer NOT NULL DEFAULT '1'`);
        await queryRunner.query(`ALTER TABLE "loan_requests" ADD "risk_score" numeric(5,2)`);
        await queryRunner.query(`ALTER TABLE "loan_requests" ADD "risk_tier" character varying(20)`);
        await queryRunner.query(`ALTER TABLE "loan_requests" ADD "pd_at_origination" numeric(6,4)`);
        await queryRunner.query(`ALTER TABLE "loan_requests" ADD "lgd_at_origination" numeric(6,4)`);
        await queryRunner.query(`ALTER TABLE "loan_requests" ADD "expected_loss" numeric(6,4)`);
        await queryRunner.query(`ALTER TABLE "loan_requests" ADD "repaid_at" TIMESTAMP`);
        await queryRunner.query(`ALTER TABLE "loan_requests" ADD "defaulted_at" TIMESTAMP`);
        await queryRunner.query(`ALTER TABLE "lending_policy_loan_limits" ADD "currency" character varying(3) NOT NULL DEFAULT 'RWF'`);
        await queryRunner.query(`ALTER TABLE "lender_policies" ADD "currency" character varying(3) NOT NULL DEFAULT 'RWF'`);
        await queryRunner.query(`ALTER TABLE "lender_policies" ADD "min_credit_score" integer`);
        await queryRunner.query(`ALTER TABLE "lender_policies" ADD "max_dti_ratio" numeric(5,4)`);
        await queryRunner.query(`ALTER TABLE "lender_policies" ADD "min_business_age_months" integer`);
        await queryRunner.query(`ALTER TABLE "lender_policies" ADD "required_kyc_level" character varying(20) NOT NULL DEFAULT 'basic'`);
        await queryRunner.query(`ALTER TABLE "lender_policies" ADD "max_ltv_ratio" numeric(5,4)`);
        await queryRunner.query(`ALTER TABLE "lender_policies" ADD "origination_fee_rate" numeric(5,4) NOT NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE "lender_policies" ADD "penalty_rate" numeric(5,4) NOT NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE "lender_policies" ADD "grace_period_days" integer NOT NULL DEFAULT '3'`);
        await queryRunner.query(`ALTER TABLE "lender_policies" ADD "early_repayment_penalty_rate" numeric(5,4) NOT NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE "lender_policies" ADD "delinquency_threshold_days" integer NOT NULL DEFAULT '30'`);
        await queryRunner.query(`ALTER TABLE "lender_policies" ADD "default_threshold_days" integer NOT NULL DEFAULT '90'`);
        await queryRunner.query(`ALTER TABLE "lender_policies" ADD "allowed_purposes" json`);
        await queryRunner.query(`ALTER TABLE "lender_policies" ADD "is_active" boolean NOT NULL DEFAULT true`);
        ...
        await queryRunner.query(`ALTER TABLE "cargo_inspections" ADD "documents" jsonb DEFAULT '[]'`);
        ...
        await queryRunner.query(`ALTER TABLE "invoices" ADD "senderId" character varying`);
        await queryRunner.query(`ALTER TABLE "invoices" ADD "senderName" character varying`);
        ...
        await queryRunner.query(`ALTER TABLE "role_permissions" DROP CONSTRAINT "PK_178199805b901ccd220ab7740ec"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_c665cbd04804c0de36c2019de5"`);
        await queryRunner.query(`ALTER TABLE "users" ALTER COLUMN "passwordHash" DROP NOT NULL`);
        await queryRunner.query(`ALTER TYPE "public"."users_role_enum" RENAME TO "users_role_enum_old"`);
        await queryRunner.query(`CREATE TYPE "public"."users_role_enum" AS ENUM('SUPER_ADMIN', 'ADMIN', 'TENANT_ADMIN', 'CARGO_OWNER', 'CARGO_RECEIVER', 'TRUCK_OWNER', 'DRIVER', 'AGENT', 'LENDER', 'BROKER', 'FLEET_MANAGER', 'FLEET_DISPATCHER', 'FLEET_ACCOUNTANT', 'FLEET_SAFETY_OFFICER', 'CUSTOMS_OFFICER')`);
        ...
        await queryRunner.query(`ALTER TABLE "system_health_logs" DROP CONSTRAINT "system_health_logs_pkey"`);
        ...
        await queryRunner.query(`ALTER TABLE "loan_terms" DROP CONSTRAINT "UQ_loan_terms_loan_request_id"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_90b21c2a5bb1e8f8694104fe82"`);
        await queryRunner.query(`ALTER TABLE "lenders" ALTER COLUMN "tenant_id" SET NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "credit_marketplace_settings" DROP CONSTRAINT "unique_tenant_marketplace"`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_5cabd03a41e07290b50bab5ee2" ON "payments" ("tenantId", "payeeId") `);
        await queryRunner.query(`CREATE INDEX "IDX_a63adf0a606940cc23e0c6a00f" ON "payments" ("payerId", "payeeId") `);
        await queryRunner.query(`CREATE INDEX "IDX_86b58f0ea2231253485e5087b0" ON "payments" ("payeeId") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_90b21c2a5bb1e8f8694104fe82" ON "lenders" ("tenant_id", "status") `);
        ...
        await queryRunner.query(`ALTER TABLE "epods" ADD CONSTRAINT "FK_d91caab5b970b8866f63765d309" FOREIGN KEY ("tripId") REFERENCES "trips"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "epods" ADD CONSTRAINT "FK_f5e453c18bd77d9cc81f5ba5545" FOREIGN KEY ("driverId") REFERENCES "drivers"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "epods" ADD CONSTRAINT "FK_f88a03adcc9e90f99ca260ebaaa" FOREIGN KEY ("cargoOwnerId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "customs_inspections" ADD CONSTRAINT "FK_618b2c89f808b69f5c72b3e3532" FOREIGN KEY ("officerId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "customs_inspections" ADD CONSTRAINT "FK_5d770b77534b211435dc540cf0b" FOREIGN KEY ("tripId") REFERENCES "trips"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "customs_compliance_responses" ADD CONSTRAINT "FK_f93160727f0dc81c051fa139fd9" FOREIGN KEY ("inspectionId") REFERENCES "customs_inspections"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "customs_compliance_responses" ADD CONSTRAINT "FK_6763bfee5af4c2fdfc1e86f303a" FOREIGN KEY ("submittedById") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "customs_compliance_responses" ADD CONSTRAINT "FK_914314cb5fc68d7c0c4d796dae6" FOREIGN KEY ("reviewedById") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "role_inheritance" DROP CONSTRAINT "FK_c118ebf755f0edce9d609279d02"`);
        ...
        await queryRunner.query(`ALTER TABLE "insurance_claims" DROP CONSTRAINT "FK_d4e396c5a1c8de48961bdf349a2"`);
        await queryRunner.query(`ALTER TABLE "insurance_claims" DROP CONSTRAINT "FK_47ae4807b3ed676f608660b8dfa"`);
        await queryRunner.query(`ALTER TABLE "multi_modal_legs" DROP CONSTRAINT "FK_3b0f09ebc541d9513e8afab1e32"`);
        await queryRunner.query(`ALTER TABLE "multi_modal_shipments" DROP CONSTRAINT "FK_013e3043db9d06f9854d4bb17d4"`);
        await queryRunner.query(`ALTER TABLE "notification_preferences" DROP CONSTRAINT "FK_b3403e8b519a383776f6c693cc9"`);
        await queryRunner.query(`ALTER TABLE "notification_preferences" DROP CONSTRAINT "FK_b70c44e8b00757584a393225593"`);
        await queryRunner.query(`ALTER TABLE "activity_logs" DROP CONSTRAINT "FK_d54f841fa5478e4734590d44036"`);
        await queryRunner.query(`ALTER TABLE "analytics_insights" DROP CONSTRAINT "FK_66f4e94935a0c84ef10772ec3d2"`);
        await queryRunner.query(`ALTER TABLE "analytics_insights" DROP CONSTRAINT "FK_db208a678e94f8c8f37fe3816b1"`);
        await queryRunner.query(`ALTER TABLE "bulk_email_logs" DROP CONSTRAINT "FK_c2a3057ae61dbd0cf6caf27a5c1"`);
        await queryRunner.query(`ALTER TABLE "bulk_email_logs" DROP CONSTRAINT "FK_75fde5dd9def7c599a714d67f6b"`);
        await queryRunner.query(`ALTER TABLE "bulk_email_logs" DROP CONSTRAINT "FK_7cb8ee9bd09df8d4fcaf012d906"`);
        await queryRunner.query(`ALTER TABLE "cargo_owner_analytics" DROP CONSTRAINT "FK_6e200f546c62dd34839d181598e"`);
        await queryRunner.query(`ALTER TABLE "cargo_owner_analytics" DROP CONSTRAINT "FK_9bca7a9dbc4e481c745b4f3285f"`);
        await queryRunner.query(`ALTER TABLE "cargo_owner_analytics" DROP CONSTRAINT "FK_7bb26828f77527d3ff1a88d05b1"`);
        await queryRunner.query(`ALTER TABLE "credit_marketplace_settings" DROP CONSTRAINT "FK_3bc8be1900291afb8b56ab05b8b"`);
        await queryRunner.query(`ALTER TABLE "credit_marketplace_settings" DROP CONSTRAINT "FK_5ac1ba7d95a8826a6cfb5011b21"`);
        await queryRunner.query(`ALTER TABLE "credit_pricing_rules" DROP CONSTRAINT "FK_d997cf3d01e7778b2986194d50f"`);
        await queryRunner.query(`ALTER TABLE "credit_pricing_rules" DROP CONSTRAINT "FK_97352a82a3e20c23bd7df1ad3ad"`);
        await queryRunner.query(`ALTER TABLE "customs_compliance_responses" DROP CONSTRAINT "FK_914314cb5fc68d7c0c4d796dae6"`);
        await queryRunner.query(`ALTER TABLE "customs_compliance_responses" DROP CONSTRAINT "FK_6763bfee5af4c2fdfc1e86f303a"`);
        await queryRunner.query(`ALTER TABLE "customs_compliance_responses" DROP CONSTRAINT "FK_f93160727f0dc81c051fa139fd9"`);
        await queryRunner.query(`ALTER TABLE "customs_inspections" DROP CONSTRAINT "FK_5d770b77534b211435dc540cf0b"`);
        await queryRunner.query(`ALTER TABLE "customs_inspections" DROP CONSTRAINT "FK_618b2c89f808b69f5c72b3e3532"`);
        await queryRunner.query(`ALTER TABLE "driver_fuel_advances" DROP CONSTRAINT "FK_70202c19a5a9040c02f1c38c182"`);
        await queryRunner.query(`ALTER TABLE "driver_fuel_advances" DROP CONSTRAINT "FK_81fd596a616bb36f9172eb2481a"`);
        await queryRunner.query(`ALTER TABLE "driver_fuel_advances" DROP CONSTRAINT "FK_f64cd8a026b9982470f57f479e0"`);
        await queryRunner.query(`ALTER TABLE "fuel_budgets" DROP CONSTRAINT "FK_6aed29ce3bd375ef016a3873b21"`);
        await queryRunner.query(`ALTER TABLE "fuel_budgets" DROP CONSTRAINT "FK_fc3274d6f51a80da8bf46fca1bf"`);
        await queryRunner.query(`ALTER TABLE "fuel_wallet_transactions" DROP CONSTRAINT "FK_9f1c742be605b50e4979187eb47"`);
        await queryRunner.query(`ALTER TABLE "fuel_wallet_transactions" DROP CONSTRAINT "FK_0adf3fef543d81a563c948f6c2a"`);
        await queryRunner.query(`ALTER TABLE "fuel_wallets" DROP CONSTRAINT "FK_eea5888de16d9fec2461723f294"`);
        await queryRunner.query(`ALTER TABLE "fuel_wallets" DROP CONSTRAINT "FK_e52f696cd5ffc8d3ef96797494a"`);
        await queryRunner.query(`ALTER TABLE "insurance_claims" DROP CONSTRAINT "FK_58b6d392b802763fda1b8cdd21d"`);
        await queryRunner.query(`ALTER TABLE "lending_policy_cargo_types" DROP CONSTRAINT "FK_e4124ffc2ef9eb6564ec1962915"`);
        await queryRunner.query(`ALTER TABLE "lending_policy_eligibility_criteria" DROP CONSTRAINT "FK_5bc4e26a401efdc294a48efdf9d"`);
        await queryRunner.query(`ALTER TABLE "lending_policy_interest_rates" DROP CONSTRAINT "FK_93ae61fd5e91923a15c598b8685"`);
        await queryRunner.query(`ALTER TABLE "lending_policy_loan_limits" DROP CONSTRAINT "FK_b7516ddeff9ac0bca90c9c33d08"`);
        await queryRunner.query(`ALTER TABLE "lending_policy_repayment" DROP CONSTRAINT "FK_42f6baf1f6be3f5a29711e1a57a"`);
        await queryRunner.query(`ALTER TABLE "lending_policy_risk_assessment" DROP CONSTRAINT "FK_a1217463c9cc7516dcf007ce6d9"`);
        await queryRunner.query(`ALTER TABLE "lending_policy_system_config" DROP CONSTRAINT "FK_e315e889a7c4d15e733070b95f0"`);
        await queryRunner.query(`ALTER TABLE "loan_terms" DROP CONSTRAINT "FK_116c853dd79fad5ec4f32008091"`);
        await queryRunner.query(`ALTER TABLE "notification_logs" DROP CONSTRAINT "FK_f803d5e1bd85942b24ee4248701"`);
        await queryRunner.query(`ALTER TABLE "notification_logs" DROP CONSTRAINT "FK_fe6690289c5e319b2ac0d809d72"`);
        await queryRunner.query(`ALTER TABLE "maintenance_logs" DROP CONSTRAINT "FK_2abbdd7df627b46588df86e4fc1"`);
        await queryRunner.query(`ALTER TABLE "maintenance_logs" DROP CONSTRAINT "FK_2b96fafe15b3ff0c0c3eb41851e"`);
        ...
        await queryRunner.query(`ALTER TABLE "security_events" DROP CONSTRAINT "FK_63fea9549fcb8977a3c0abd7833"`);
        ...
        await queryRunner.query(`ALTER TABLE "tenant_kyc_audit_log" DROP CONSTRAINT "FK_b1a4f3a3fb4892c7d23c1270726"`);
        await queryRunner.query(`ALTER TABLE "tenant_kyc_audit_log" DROP CONSTRAINT "FK_808e971782408664b9c7698a9dd"`);
        await queryRunner.query(`ALTER TABLE "tenant_kyc_documents" DROP CONSTRAINT "FK_099ab4bc9a89e3d40c12875d155"`);
        await queryRunner.query(`ALTER TABLE "tenant_kyc_documents" DROP CONSTRAINT "FK_0f6ffb96f893d9f75b205882c62"`);
        await queryRunner.query(`ALTER TABLE "tenant_kyc_documents" DROP CONSTRAINT "FK_9ccc21465f0cc832c821d48a4b0"`);
        await queryRunner.query(`ALTER TABLE "tenant_subscriptions" DROP CONSTRAINT "FK_cb2ac3bd398220d534c92db8b2e"`);
        await queryRunner.query(`ALTER TABLE "tenant_subscriptions" DROP CONSTRAINT "FK_c59c97d5c1343951e044c137f02"`);
        await queryRunner.query(`ALTER TABLE "credit_transactions" DROP CONSTRAINT "FK_cec145f863cf10a14ecd9f47090"`);
        await queryRunner.query(`ALTER TABLE "credit_transactions" DROP CONSTRAINT "FK_77840254310a94486bc1773735f"`);
        await queryRunner.query(`ALTER TABLE "credit_transactions" DROP CONSTRAINT "FK_c8bc6d59f7c92922a2c691548d7"`);
        await queryRunner.query(`ALTER TABLE "credit_transactions" DROP CONSTRAINT "FK_c2694a0c5f7cbf8d96bc43273be"`);
        await queryRunner.query(`ALTER TABLE "credit_accounts" DROP CONSTRAINT "FK_e9e4079e4a9bc1ddeb3452b7f69"`);
        await queryRunner.query(`ALTER TABLE "credit_accounts" DROP CONSTRAINT "FK_872ba75a97257de9a4bf8557ffa"`);
        await queryRunner.query(`ALTER TABLE "subscription_payments" DROP CONSTRAINT "FK_173289b1de8485fbb852ff08fa8"`);
        await queryRunner.query(`ALTER TABLE "subscription_payments" DROP CONSTRAINT "FK_3d76b7ca2d964925a54ad9fd516"`);
        await queryRunner.query(`ALTER TABLE "user_kyc_audit_log" DROP CONSTRAINT "FK_52c650b77259d2495b15b67769f"`);
        await queryRunner.query(`ALTER TABLE "user_kyc_audit_log" DROP CONSTRAINT "FK_d5b619ad0cef9a8dc2666d4cb6f"`);
        await queryRunner.query(`ALTER TABLE "user_kyc_audit_log" DROP CONSTRAINT "FK_e1d131cc51fb6cdb698da6daba2"`);
        await queryRunner.query(`ALTER TABLE "user_kyc_documents" DROP CONSTRAINT "FK_d1eb93b1634018ae411173943b6"`);
        await queryRunner.query(`ALTER TABLE "user_kyc_documents" DROP CONSTRAINT "FK_1b8ced93a14a57a3a8cf5553440"`);
        await queryRunner.query(`ALTER TABLE "user_kyc_documents" DROP CONSTRAINT "FK_f0d33db611c87e2bca1f9f7edf6"`);
        await queryRunner.query(`ALTER TABLE "user_permission_overrides" DROP CONSTRAINT "FK_05cf99c180d170ed758f03a80fe"`);
        ...
        await queryRunner.query(`ALTER TABLE "epods" DROP CONSTRAINT "FK_f88a03adcc9e90f99ca260ebaaa"`);
        await queryRunner.query(`ALTER TABLE "epods" DROP CONSTRAINT "FK_f5e453c18bd77d9cc81f5ba5545"`);
        await queryRunner.query(`ALTER TABLE "epods" DROP CONSTRAINT "FK_d91caab5b970b8866f63765d309"`);
        await queryRunner.query(`ALTER TABLE "loads" DROP CONSTRAINT "FK_20cae08ac027e8f02fa76440b1f"`);
        await queryRunner.query(`ALTER TABLE "loads" DROP CONSTRAINT "FK_f7e8115cc0ad9befebb3a666f4c"`);
        await queryRunner.query(`ALTER TABLE "trucks" DROP CONSTRAINT "FK_8c4c103d41f1f81a82506ed7504"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_aa8dcbb39c06587a1cf834da38"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_1fa31efc2a0bc0b517b9f7225d"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_6a292c4dedc54c3610173796da"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_01b16a9f40838c61df9d8f2397"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_558fbfc6d3ed76397f133aa835"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_97352a82a3e20c23bd7df1ad3a"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_d997cf3d01e7778b2986194d50"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_a43ae68351096e8568a06382f1"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_6a17042a7646c9c2a6d3ccef22"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_ea1e8001e18da625271cb36faf"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_8b1e30132e1b27cbb9cc63055e"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_e6a291fa1f367d1580ebd3ff41"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_dbc00de019adde78acb4c7750d"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_5a2ef9676a68d2dd52b59d72b0"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_d0f9a2a260ee0f538c19d7c2a9"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_bc11f2da1320a870676faa8fed"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_2e99675306663490ddfe9b8240"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_1fd8e9227c063c682884b93134"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_626bd18a1c31262c92de2ea7fc"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_7c69728b0eee8df90aa28cb3aa"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_1f5409092a6270aa78f5ef090b"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_dd355d444598693fc3bf82fea8"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_f2cc1127ccebde810e3a4f798c"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_d85cc00ebf68d5db0073b5bd62"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_b039730036806258874142386e"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_6bcdd18e09cde925d9927e72ae"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_813270e00e2d415496bb82419a"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_583ca0d5b2d68c75108227af9c"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_d7cbd8189238705b3d8ed1db66"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_e76fdb341655fca56beef59750"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_6be27131d692a211fda9b877a4"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_e7276e088808d17c3350b9b3f5"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_e315e889a7c4d15e733070b95f"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_90b21c2a5bb1e8f8694104fe82"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_116c853dd79fad5ec4f3200809"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_3bf04f0b74badf9ad6f7bbc010"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_ccf071140daa090281ed389288"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_469b81bb95497287c259fa5628"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_9d6c96fc3270ba756ae1e1e20b"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_93eb201c7a9603e415301e69a0"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_9b2e0e69131e085736edccaec5"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_797841712968aa775af0cb0b54"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_13c6c844995d9cc303e7e05087"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_db8d3f73a58b39fc0c14302840"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_9c3e6cc717b4f6dc1b0260030f"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_7a0a6e2a61cf2f91c80a1c6701"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_c0dfddafd5d9d49593930be293"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_d86aa84090327c9a94aee62e18"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_d1891b273f5c77638d2149a9f0"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_63fea9549fcb8977a3c0abd783"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_ac0419c594360d319a6a453591"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_7567faf52e0f0da34dbab2daf3"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_797d199fff9037e5b231dc4ffb"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_59d0580779f1111eafa7438a96"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_808e971782408664b9c7698a9d"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_3bd81217db13f966e5509f559a"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_3c410bba0742f62a0d29b9eb7d"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_9ccc21465f0cc832c821d48a4b"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_ff7f7505116709a5fc37955422"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_bd3a27c92d65df4ccc89ffa3a8"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_c59c97d5c1343951e044c137f0"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_05f0369a57a0c7c0bdaebe0a40"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_b79fb41debf9b4f464db5fd565"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_51367f4601eb1a60444512646d"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_f4a5574cb41935313243a5eae7"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_8ecced8d9f776030ab2060f3f2"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_c1b2afb65de0f9494f2981e131"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_2c0395713680ab5eb6c8d001d0"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_9ac41a5292ef4d8356a86be30c"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_595ba72b7adb92ee80c0837694"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_22fb71850b9ff42bd211569c81"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_5c28e3be70b859f2f9a99c3a5c"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_e9e4079e4a9bc1ddeb3452b7f6"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_e1265f24538173a087762a9745"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_173289b1de8485fbb852ff08fa"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_3e51a39cdc9a809c529b1535f7"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_86b58f0ea2231253485e5087b0"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_a63adf0a606940cc23e0c6a00f"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_5cabd03a41e07290b50bab5ee2"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_0ebf9b0f0cbd7b2fb5b62e3fac"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_686d1ea5af1256411104b26548"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_37b11c00133f4561aa6980ca33"`);
        await queryRunner.query(`ALTER TABLE "insurance_policies" DROP COLUMN "insuranceCompany"`);
        await queryRunner.query(`ALTER TABLE "insurance_policies" ADD "insuranceCompany" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "insurance_policies" DROP CONSTRAINT "UQ_baa50eb26aac0be1b692c080fbf"`);
        await queryRunner.query(`ALTER TABLE "insurance_policies" DROP COLUMN "policyNumber"`);
        ...
        await queryRunner.query(`ALTER TABLE "lenders" ALTER COLUMN "tenant_id" DROP NOT NULL`);
        await queryRunner.query(`CREATE INDEX "IDX_90b21c2a5bb1e8f8694104fe82" ON "lenders" ("tenant_id", "status") `);
        ...
        await queryRunner.query(`ALTER TABLE "system_health_logs" DROP CONSTRAINT "PK_48ac00277cf6992c147dab10e7d"`);
        await queryRunner.query(`ALTER TABLE "system_health_logs" DROP COLUMN "id"`);
        ...
        await queryRunner.query(`ALTER TABLE "tenants" DROP CONSTRAINT "UQ_06e11d5ca528baa2288ac10c6c5"`);
        ...
        await queryRunner.query(`ALTER TABLE "invoices" DROP COLUMN "senderName"`);
        await queryRunner.query(`ALTER TABLE "invoices" DROP COLUMN "senderId"`);
        await queryRunner.query(`ALTER TABLE "insurance_policies" DROP COLUMN "deletedAt"`);
        await queryRunner.query(`ALTER TABLE "insurance_policies" DROP COLUMN "createdBy"`);
        await queryRunner.query(`ALTER TABLE "insurance_policies" DROP COLUMN "tenantId"`);
        await queryRunner.query(`ALTER TABLE "insurance_policies" DROP COLUMN "agentEmail"`);
        ...
        await queryRunner.query(`ALTER TABLE "notification_preferences" DROP COLUMN "userId"`);
        await queryRunner.query(`ALTER TABLE "notification_preferences" DROP COLUMN "tenantId"`);
        await queryRunner.query(`ALTER TABLE "cargo_inspections" DROP COLUMN "documents"`);
        ...
        await queryRunner.query(`ALTER TABLE "insurance_claims" DROP COLUMN "adjuster"`);
        await queryRunner.query(`ALTER TABLE "insurance_claims" DROP COLUMN "truckId"`);
        await queryRunner.query(`ALTER TABLE "lender_policies" DROP COLUMN "is_active"`);
        await queryRunner.query(`ALTER TABLE "lender_policies" DROP COLUMN "allowed_purposes"`);
        await queryRunner.query(`ALTER TABLE "lender_policies" DROP COLUMN "default_threshold_days"`);
        await queryRunner.query(`ALTER TABLE "lender_policies" DROP COLUMN "delinquency_threshold_days"`);
        await queryRunner.query(`ALTER TABLE "lender_policies" DROP COLUMN "early_repayment_penalty_rate"`);
        await queryRunner.query(`ALTER TABLE "lender_policies" DROP COLUMN "grace_period_days"`);
        await queryRunner.query(`ALTER TABLE "lender_policies" DROP COLUMN "penalty_rate"`);
        await queryRunner.query(`ALTER TABLE "lender_policies" DROP COLUMN "origination_fee_rate"`);
        await queryRunner.query(`ALTER TABLE "lender_policies" DROP COLUMN "max_ltv_ratio"`);
        await queryRunner.query(`ALTER TABLE "lender_policies" DROP COLUMN "required_kyc_level"`);
        await queryRunner.query(`ALTER TABLE "lender_policies" DROP COLUMN "min_business_age_months"`);
        await queryRunner.query(`ALTER TABLE "lender_policies" DROP COLUMN "max_dti_ratio"`);
        await queryRunner.query(`ALTER TABLE "lender_policies" DROP COLUMN "min_credit_score"`);
        await queryRunner.query(`ALTER TABLE "lender_policies" DROP COLUMN "currency"`);
        await queryRunner.query(`ALTER TABLE "lending_policy_loan_limits" DROP COLUMN "currency"`);
        await queryRunner.query(`ALTER TABLE "loan_requests" DROP COLUMN "defaulted_at"`);
        await queryRunner.query(`ALTER TABLE "loan_requests" DROP COLUMN "repaid_at"`);
        await queryRunner.query(`ALTER TABLE "loan_requests" DROP COLUMN "expected_loss"`);
        await queryRunner.query(`ALTER TABLE "loan_requests" DROP COLUMN "lgd_at_origination"`);
        await queryRunner.query(`ALTER TABLE "loan_requests" DROP COLUMN "pd_at_origination"`);
        await queryRunner.query(`ALTER TABLE "loan_requests" DROP COLUMN "risk_tier"`);
        await queryRunner.query(`ALTER TABLE "loan_requests" DROP COLUMN "risk_score"`);
        await queryRunner.query(`ALTER TABLE "loan_requests" DROP COLUMN "ifrs9_stage"`);
        await queryRunner.query(`ALTER TABLE "loan_requests" DROP COLUMN "days_past_due"`);
        await queryRunner.query(`ALTER TABLE "loan_requests" DROP COLUMN "grace_period_end"`);
        await queryRunner.query(`ALTER TABLE "loan_requests" DROP COLUMN "ltv_ratio"`);
        await queryRunner.query(`ALTER TABLE "loan_requests" DROP COLUMN "collateral_value"`);
        await queryRunner.query(`ALTER TABLE "loan_requests" DROP COLUMN "collateral_description"`);
        await queryRunner.query(`ALTER TABLE "loan_requests" DROP COLUMN "apr"`);
        await queryRunner.query(`ALTER TABLE "loan_requests" DROP COLUMN "total_cost_of_credit"`);
        await queryRunner.query(`ALTER TABLE "loan_requests" DROP COLUMN "origination_fee_amount"`);
        await queryRunner.query(`ALTER TABLE "loan_requests" DROP COLUMN "origination_fee_rate"`);
        await queryRunner.query(`ALTER TABLE "loan_requests" DROP COLUMN "currency"`);
        await queryRunner.query(`ALTER TABLE "loan_requests" DROP COLUMN "kyc_verified"`);
        await queryRunner.query(`ALTER TABLE "loan_requests" DROP COLUMN "purpose"`);
        await queryRunner.query(`ALTER TABLE "loan_requests" DROP CONSTRAINT "UQ_4382ec13ee491f4b516b8549d26"`);
        await queryRunner.query(`ALTER TABLE "loan_requests" DROP COLUMN "loan_number"`);
        ...
        await queryRunner.query(`ALTER TABLE "routes" DROP COLUMN "destination_address"`);
        await queryRunner.query(`ALTER TABLE "routes" DROP COLUMN "destination_lng"`);
        await queryRunner.query(`ALTER TABLE "routes" DROP COLUMN "destination_lat"`);
        await queryRunner.query(`ALTER TABLE "routes" DROP COLUMN "origin_address"`);
        await queryRunner.query(`ALTER TABLE "routes" DROP COLUMN "origin_lng"`);
        await queryRunner.query(`ALTER TABLE "routes" DROP COLUMN "origin_lat"`);
        ...
        await queryRunner.query(`ALTER TABLE "payments" DROP COLUMN "payeeId"`);
        await queryRunner.query(`ALTER TABLE "user_scores" DROP COLUMN "tenantId"`);
        ...
        await queryRunner.query(`ALTER TABLE "auctions" DROP COLUMN "minimumBidDecrement"`);
        await queryRunner.query(`ALTER TABLE "auctions" DROP COLUMN "autoExtend"`);
        await queryRunner.query(`ALTER TABLE "auctions" DROP COLUMN "selectionCriteria"`);
        await queryRunner.query(`ALTER TABLE "auctions" DROP COLUMN "allowBidRevision"`);
        await queryRunner.query(`ALTER TABLE "auctions" DROP COLUMN "bidVisibility"`);
        await queryRunner.query(`ALTER TABLE "auctions" DROP COLUMN "dropAmount"`);
        await queryRunner.query(`ALTER TABLE "auctions" DROP COLUMN "dropInterval"`);
        await queryRunner.query(`ALTER TABLE "auctions" DROP COLUMN "marketRate"`);
        await queryRunner.query(`ALTER TABLE "auctions" DROP COLUMN "startingPrice"`);
        await queryRunner.query(`ALTER TABLE "auctions" DROP COLUMN "maxBudget"`);
        await queryRunner.query(`ALTER TABLE "auctions" DROP COLUMN "targetPrice"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_c118ebf755f0edce9d609279d0"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_d6988ec6a7ed344657de8b7e0e"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_34c3d35482c852a5b1994720c8"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_2e736b729859342dec27976bc8"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_388821de26f6747a5e8170f8d8"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_e34700859a7a3bcc855808a0f7"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_df3b25181df0b4b59bd93f16e1"`);
        await queryRunner.query(`DROP TABLE "api_keys"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_af7d535aea2fc3ca1eb561ad30"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_a3de91fac75e0f8c03a52af32a"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_c7ea716d05f5325c4130a6867e"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_38cc58643129eb7b03ea8cb6e5"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_98b2a588d40bd09bbf3437b9b0"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_195490440ff2eace58959bbe1c"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_6e200f546c62dd34839d181598"`);
        await queryRunner.query(`DROP TABLE "cargo_owner_analytics"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_ace05c8e81c471323d1dee4567"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_9cf5dbea5c6f64eb8f48fe0506"`);
        await queryRunner.query(`DROP TABLE "carrier_tiers"`);
        await queryRunner.query(`DROP TYPE "public"."carrier_tiers_previoustier_enum"`);
        await queryRunner.query(`DROP TYPE "public"."carrier_tiers_tier_enum"`);
        await queryRunner.query(`DROP TABLE "currencies"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_2f1f1bdb5046fa5c43cbfeb23b"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_a112819bd3e30e139f6fb175f0"`);
        await queryRunner.query(`DROP TABLE "customs_checkpoints"`);
        await queryRunner.query(`DROP TYPE "public"."customs_checkpoints_type_enum"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_f93160727f0dc81c051fa139fd"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_6763bfee5af4c2fdfc1e86f303"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_40d2ede4cf9edc8fd065c89d49"`);
        await queryRunner.query(`DROP TABLE "customs_compliance_responses"`);
        await queryRunner.query(`DROP TYPE "public"."customs_compliance_responses_status_enum"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_e1677825b2bc4a6d8e579b9e53"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_0e96a836c8168d21369bf49d17"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_13fc32060c7bb57af14bedebb8"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_02cd4dc58d3e19f91e5c76f588"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_536dc50e6fb907218efee3f223"`);
        await queryRunner.query(`DROP TABLE "customs_inspections"`);
        await queryRunner.query(`DROP TYPE "public"."customs_inspections_holdtype_enum"`);
        await queryRunner.query(`DROP TYPE "public"."customs_inspections_examtype_enum"`);
        await queryRunner.query(`DROP TYPE "public"."customs_inspections_inspectionchannel_enum"`);
        await queryRunner.query(`DROP TYPE "public"."customs_inspections_risklevel_enum"`);
        await queryRunner.query(`DROP TYPE "public"."customs_inspections_status_enum"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_9f3d031a4792835a4acee284c5"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_ce280779f3149fad2149bf910a"`);
        await queryRunner.query(`DROP TABLE "exchange_rates"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_0d100cf8bbd893a0469deb488d"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_5ce2b1aebad387c1afe3a41343"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_48e45ac17b4e397bc55d22c153"`);
        await queryRunner.query(`DROP TABLE "fuel_budgets"`);
        await queryRunner.query(`DROP TYPE "public"."fuel_budgets_status_enum"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_abeb7de67b5ba7dff9860545b6"`);
        await queryRunner.query(`DROP TABLE "geofence_zones"`);
        await queryRunner.query(`DROP TYPE "public"."geofence_zones_type_enum"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_1af373960050ecb35914150112"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_7ca4ed34a4206249d7092751bc"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_a95cd3c455317ef9fd18f95050"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_5f4c893f2ee8263e346dfa1bf8"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_89cf3cc132d3dbc4f57818600d"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_2cc379d4395eaeedab6b740e39"`);
        await queryRunner.query(`DROP TABLE "private_carrier_networks"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_c6b16825957aaaae73864ef1fc"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_2fd40f6797a523eaf0f85e7aee"`);
        await queryRunner.query(`DROP TABLE "revenue_records"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_e1d131cc51fb6cdb698da6daba"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_d5b619ad0cef9a8dc2666d4cb6"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_08e2c9330c96799fbbcc471190"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_ed69c699355cfd7536cab85e11"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_f0d33db611c87e2bca1f9f7edf"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_1b8ced93a14a57a3a8cf555344"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_d9fe14eea34dd7d7a8f2e16331"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_bdb69f93aceaa2c078ed604651"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_e4cdc64b38672f20cd6ed6a1d3"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_e929f0bed4987cb835b89e31b7"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_1d942b6fc3eeefb988291fb128"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_85a618dede80136ba35a03b6a4"`);
        await queryRunner.query(`DROP TABLE "user_permission_overrides"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_d91caab5b970b8866f63765d30"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_8697e3af559e7fa64541e43e06"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_f88a03adcc9e90f99ca260ebaa"`);
        await queryRunner.query(`DROP TABLE "epods"`);
        await queryRunner.query(`DROP TYPE "public"."epods_status_enum"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_09b6bf4f7d311a8f7192c4ee0c"`);
