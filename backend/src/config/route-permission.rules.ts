...
export const ROUTE_PERMISSION_RULES: RoutePermissionRule[] = [
  ...
  { methods: ['PATCH'], pattern: /^capacity\/offers/, permissions: ['fleet:view_own', 'matching:respond'] },
  { methods: ['POST'], pattern: /^capacity\/(offers\/.*\/close|bookings\/.*\/(accept|reject))/, permissions: ['fleet:view_own', 'matching:respond'] },
  { pattern: /^capacity(\/|$)/, permissions: ['cargo:view', 'cargo:create', 'fleet:view_own', 'matching:request', 'matching:respond'] },
