...
const FALLBACK_ROLE_DEFAULTS: Record<string, string[]> = {
  ...
  TRUCK_OWNER: [
    ...
    'matching:respond', 'trips:view', 'trips:start', 'trips:complete', 'trips:cancel', 'trips:assign_driver',
  ...
  FLEET_MANAGER: ['fleet:view', 'fleet:edit', 'trips:assign_driver', 'trips:start', 'trips:complete', 'trips:cancel', 'lending:view_own', 'lending:create_request'],
  FLEET_DISPATCHER: ['trips:assign_driver', 'trips:start', 'trips:complete', 'trips:cancel', 'fleet:view'],
