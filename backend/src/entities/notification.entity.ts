...
export enum NotificationType {
  ...
  PARKING_RESERVATION_SUBMITTED = 'PARKING_RESERVATION_SUBMITTED',
  PARKING_RESERVATION_ASSIGNED = 'PARKING_RESERVATION_ASSIGNED',
  PARKING_RESERVATION_INFO_REQUIRED = 'PARKING_RESERVATION_INFO_REQUIRED',
  PARKING_RESERVATION_APPROVED = 'PARKING_RESERVATION_APPROVED',
  PARKING_RESERVATION_REJECTED = 'PARKING_RESERVATION_REJECTED',
  PARKING_RESERVATION_CANCELLED = 'PARKING_RESERVATION_CANCELLED',
  PARKING_RESERVATION_PAYMENT_DUE = 'PARKING_RESERVATION_PAYMENT_DUE',
  PARKING_RESERVATION_PAYMENT_RECEIVED = 'PARKING_RESERVATION_PAYMENT_RECEIVED',
