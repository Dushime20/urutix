// This is the content that should replace the "Manage Partners" tab in SubscriptionPlans.tsx
// Copy this entire section to replace lines 1198-1340 in SubscriptionPlans.tsx
