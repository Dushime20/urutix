              ...
              <div className="grid gap-6">
                {subscriptionsData.data.map((subscription: any) => (
                  ...
                  >
                    ...
                    {/* Marketplace-Focused Credit Overview */}
                    <div className="bg-slate-50 rounded-[24px] p-6 mb-6 border-2 border-slate-100">
                      <div className="flex items-center justify-between mb-6">
                        <h4 className="text-[11px] font-black text-slate-700 uppercase tracking-widest flex items-center gap-2">
                          <FaStore className="text-[#345E85]" />
                          Credit Marketplace Overview - {subscription.plan?.name}
                        </h4>
                      ...
                      <div className="grid md:grid-cols-4 gap-4 mb-6">
                        {/* Total Credits in This Subscription */}
                        <div className="bg-white rounded-[16px] p-4 border-2 border-blue-50">
                          <div className="text-[9px] font-black text-slate-400 uppercase tracking-widest mb-2">
                            This Subscription
                          </div>
                          <div className="text-2xl font-black text-[#345E85]">
                        ...
                        {/* Credits Remaining in This Subscription */}
                        <div className="bg-white rounded-[16px] p-4 border-2 border-emerald-50">
                          <div className="text-[9px] font-black text-slate-400 uppercase tracking-widest mb-2">
                            Remaining
                          </div>
                        ...
                        {/* Credits Used from This Subscription */}
                        <div className="bg-white rounded-[16px] p-4 border-2 border-red-50">
                          <div className="text-[9px] font-black text-slate-400 uppercase tracking-widest mb-2">
                            Used from This
                          </div>
                          <div className="text-2xl font-black text-red-600">
                            {((subscription.plan?.totalCredits || 0) - (subscription.availableCredits || subscription.plan?.totalCredits || 0)).toLocaleString()}
                          </div>
                        ...
                        {/* Usage Percentage */}
                        <div className="bg-white rounded-[16px] p-4 border-2 border-purple-50">
                          <div className="text-[9px] font-black text-slate-400 uppercase tracking-widest mb-2">
                            Usage Rate
                          </div>
                          <div className="text-2xl font-black text-purple-600">
                            {subscription.plan?.totalCredits > 0 
                              ? `${(((subscription.plan.totalCredits - (subscription.availableCredits || subscription.plan.totalCredits)) / subscription.plan.totalCredits) * 100).toFixed(1)}%`
                              : '0%'}
                          </div>
                          <div className="text-[9px] font-bold text-purple-500 mt-1">
                            Of This Plan
                          </div>
                        </div>
                      </div>

                      {/* Subscription-Specific Balance Calculation */}
                      <div className="bg-white rounded-[16px] p-4 border border-slate-200 mb-4">
                        ...
                        <div className="flex items-center justify-center gap-3 text-sm font-bold">
                          <div className="text-center">
                            ...
                            <div className="text-[9px] text-slate-500 mt-1">Purchased</div>
                          </div>
                          ...
                          <div className="text-slate-400 text-xl">=</div>
                          <div className="text-center bg-emerald-50 rounded-lg px-4 py-2">
                            <div className="text-2xl font-black text-emerald-900">
                              {subscription.availableCredits?.toLocaleString() || subscription.plan?.totalCredits?.toLocaleString() || '0'}
                            </div>
                            <div className="text-[9px] text-emerald-600 mt-1 font-black">Remaining</div>
                          </div>
                        </div>
                      </div>

                      {/* Progress Bar for This Subscription */}
                      {subscription.plan?.totalCredits > 0 && (
                        <div className="bg-white rounded-[16px] p-4 border border-slate-200 mb-4">
                          <div className="flex items-center justify-between mb-2">
                            <span className="text-[10px] font-black text-slate-600 uppercase tracking-wider">Credit Usage Progress</span>
                            <span className="text-[10px] font-black text-slate-600">
                              {subscription.availableCredits?.toLocaleString() || subscription.plan?.totalCredits?.toLocaleString() || 0} / {subscription.plan?.totalCredits?.toLocaleString() || 0} remaining
                            </span>
                          </div>
                          <div className="h-3 bg-slate-200 rounded-full overflow-hidden">
                            <div 
                              ...
                              style={{ 
                                width: `${Math.max(0, ((subscription.availableCredits || subscription.plan?.totalCredits || 0) / (subscription.plan?.totalCredits || 1)) * 100)}%` 
                              }}
                            />
                          </div>
                      ...
                      {/* Tenant-Level Marketplace Stats (All Subscriptions Combined) */}
                      <div className="border-t border-slate-200 pt-4 mt-4">
                        <div className="text-[10px] font-black text-slate-600 uppercase tracking-widest mb-3">
                          Overall Marketplace Performance (All Subscriptions)
                        </div>
                        <div className="grid md:grid-cols-3 gap-4">
                          <div className="bg-gradient-to-br from-emerald-50 to-emerald-100 rounded-[16px] p-4 border border-emerald-200">
                            <div className="text-[9px] font-black text-emerald-700 uppercase tracking-widest mb-2">
                              Total Revenue
                            </div>
                            <div className="text-2xl font-black text-emerald-900">
                            ...
                            <div className="text-[9px] font-bold text-emerald-600 mt-1">
                              From {marketplaceStatsData?.data?.totalTransactions || 0} Sales
                            </div>
                          </div>

                          <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-[16px] p-4 border border-blue-200">
                            <div className="text-[9px] font-black text-blue-700 uppercase tracking-widest mb-2">
                              Credits Sold
                            </div>
                            <div className="text-2xl font-black text-blue-900">
                          ...
                          <div className="bg-gradient-to-br from-amber-50 to-amber-100 rounded-[16px] p-4 border border-amber-200">
                      ...
                      <div className="mt-4 bg-blue-50 border border-blue-100 rounded-xl p-3">
                        <div className="flex items-start gap-2">
                          ...
                          <div className="text-[10px] text-slate-600 leading-relaxed">
                            <span className="font-black">Subscription Tracking:</span> Each subscription is tracked separately. 
                            This subscription has {subscription.availableCredits?.toLocaleString() || subscription.plan?.totalCredits?.toLocaleString() || 0} credits remaining out of {subscription.plan?.totalCredits?.toLocaleString() || 0} purchased. 
                            The "Overall Marketplace Performance" section shows combined stats from all your subscriptions.
                          </div>
                        </div>
                      </div>
                    </div>
