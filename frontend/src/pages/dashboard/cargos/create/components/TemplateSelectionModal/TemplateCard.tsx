...
const TemplateCard: React.FC<TemplateCardProps> = ({ template, onSelect }) => {
  ...
  return (
    <div
      className={cn(
        "group relative bg-white border border-gray-200 rounded-xl p-5 hover:border-teal-400 hover:shadow-lg",
    ...
    >
      ...
      <div className="flex flex-1 items-start mb-6">
        <div className="bg-gradient-to-br from-gray-100 to-gray-200 rounded-lg p-3 mr-3 group-hover:from-teal-500 group-hover:to-teal-600 transition-all duration-300">
          <Icon className="text-gray-600 group-hover:text-white w-5 h-5" />
        </div>
        <div className="flex-1">
          <h3 className="text-base font-semibold text-gray-900 mb-1.5 group-hover:text-teal-600 transition-colors">
            {template.title}
          </h3>
      ...
      <div className="space-y-3 mb-5">
        <div className="grid grid-cols-2 gap-3">
          <div className="flex items-center p-2.5 bg-gray-50 rounded-lg">
            <FaWeight className="text-gray-500 w-3.5 h-3.5 mr-2" />
            <div>
          ...
          <div className="flex items-center p-2.5 bg-gray-50 rounded-lg">
            <FaDollarSign className="text-gray-500 w-3.5 h-3.5 mr-2" />
            <div>
        ...
        {/* Urgency Level */}
        <div className="flex items-center p-2.5 bg-gray-50 rounded-lg">
          <FaClock className="text-gray-500 w-3.5 h-3.5 mr-2" />
          <div className="flex-1">
            ...
            <div className="flex items-center gap-2">
              ...
              <span
                className={`font-medium px-2 py-0.5 rounded-full text-xs border ${getUrgencyColor(
      ...
      {/* Action Button */}
      <SmartButton
        className="flex gap-2 group-hover:from-teal-600 group-hover:to-teal-700 hover:!from-teal-700 hover:!to-teal-800"
