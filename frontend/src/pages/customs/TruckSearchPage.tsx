        ...
        <form onSubmit={handleSearch} className="flex gap-3">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-3 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-[#2c5173]/30"
        ...
        <div className="space-y-3">
          ...
          {isLoading ? (
            ...
            results.map((r: any) => (
              <div
                key={r.tripId}
                className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-700 p-5 hover:border-[#2c5173]/40 hover:shadow-md transition-all"
              >
                <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
                  <div className="flex gap-4">
                    {/* Truck icon */}
                    <div className="w-12 h-12 rounded-xl bg-blue-50 flex items-center justify-center flex-shrink-0">
                      <Truck className="w-6 h-6 text-[#2c5173]" />
                    </div>
                  ...
                  <div className="flex gap-2 flex-shrink-0 flex-wrap justify-end">
                    ...
                    {r.lastInspectionId ? (
                      <button
                        ...
                        className="px-4 py-2 rounded-xl text-xs font-bold border border-[#2c5173] text-[#2c5173] hover:bg-[#2c5173]/5 transition-colors flex items-center gap-1"
                      >
                    ...
                    <div className="flex flex-wrap gap-2">
                      {r.documents.map((doc: any) => (
                        <a
                          ...
                          className="flex items-center gap-1.5 px-3 py-1.5 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg text-xs font-semibold text-slate-700 dark:text-slate-300 hover:border-[#2c5173]/50 hover:text-[#2c5173] transition-colors"
                        >
                          <FileText size={11} />
                  ...
                  <div className="space-y-2">
                    {selectedTrip.documents.map((doc: any) => (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center gap-3 px-4 py-3 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl hover:border-[#2c5173]/50 hover:bg-[#2c5173]/5 dark:hover:bg-slate-700 transition-all group"
                      >
                        ...
                        <ExternalLink size={12} className="text-slate-300 group-hover:text-[#2c5173] flex-shrink-0 transition-colors" />
                      </a>
                    ))}
                  </div>
                ) : (
            ...
            <div className="flex gap-3 p-5 border-t border-slate-100 dark:border-slate-800 sticky bottom-0 bg-white dark:bg-slate-900 rounded-b-2xl">
              ...
              {selectedTrip.lastInspectionId && (
                <button
                  ...
                  className="flex-1 px-4 py-2.5 rounded-xl border border-[#2c5173] text-[#2c5173] text-sm font-bold hover:bg-[#2c5173]/5 transition-colors flex items-center justify-center gap-2"
                >
