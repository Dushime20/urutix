  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-6 gap-4">
        ...
        <StatCard title="Information Required" value={stats?.additionalInformationRequired ?? 0} color="warning" variant="modern" icon={<AlertTriangle className="w-5 h-5" />} loading={statsQuery.isLoading} onClick={() => { setStatus('ADDITIONAL_INFORMATION_REQUIRED'); setPage(1); }} />
