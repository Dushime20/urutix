...
import { CheckCircle2, Circle, UserCheck, ArrowRight } from 'lucide-react';
...
const AgentPasswordSetup = () => {
  ...
  const onSubmit = async (data: PasswordSetupFormData) => {
    ...
    try {
      setIsLoading(true);
      await authAPI.setupAgentPassword({ token, password: data.password, confirmPassword: data.confirmPassword });
      setIsSuccess(true);
          ...
          <div className="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
            <div className="px-6 pt-8 pb-4 text-center">
              ...
              <p className="text-sm text-gray-600 mb-6">
                Your Agent account is now active. You can log in and access your dashboard.
              </p>
      ...
      <div className="w-full max-w-2xl px-4 relative z-10">
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
          <div className="px-8 pt-8 pb-4">
            <div className="flex justify-center mb-4">
              <div className="bg-teal-50 rounded-full p-3 border-2 border-teal-200">
            ...
            <p className="text-sm font-medium text-slate-500 text-center">
              Welcome to UrutiX! Your Agent account has been created. Please set a secure password to get started.
            </p>
          </div>
...
export default AgentPasswordSetup;
