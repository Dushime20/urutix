        ...
        <div className="min-h-screen bg-slate-50 font-sans">
            ...
            <div className="bg-[#0f172a] text-white">
                <AdminHeader
                    ...
                    onSearch={(val) => {
                        // Optional: Implement client-side search filtering of settings if desired
                        console.log('Searching settings:', val);
                    }}
                />
                ...
                <div className="bg-gradient-to-b from-[#0f172a] to-[#1e293b]">
                    <div className="max-w-[1536px] mx-auto px-4 md:px-8 lg:px-12 xl:px-20 py-8 pb-12 flex flex-col md:flex-row md:items-center justify-between gap-6">
                        <div>
                            <h1 className="text-3xl md:text-4xl font-black text-white mb-2 tracking-tight">System Settings</h1>
                            <p className="text-slate-400 max-w-xl">Configure platform-wide settings, notifications, and feature flags.</p>
                        </div>
