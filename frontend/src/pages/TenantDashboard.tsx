...
interface TenantDashboardPageProps {
  defaultView?: 'overview' | 'fleet' | 'cargo' | 'financial' | 'operations' | 'users' | 'trips' | 'settings' | 'bidding' | 'purchase-credits' | 'billing' | 'subscription-plans' | 'communicate' | 'drivers' | 'profile' | 'lenders' | 'kyc' | 'reports';
}
