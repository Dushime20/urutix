...
const TruckOwnerPasswordSetup = () => {
  ...
  const onSubmit = async (data: PasswordSetupFormData) => {
    ...
    try {
      setIsLoading(true);
      // Use the driver password setup endpoint (works for all user types)
          ...
          <div className="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
            <div className="px-6 pt-8 pb-4 text-center">
              ...
              <p className="text-sm text-gray-600 mb-6">
                Your truck owner account has been activated. You can now log in to access your fleet dashboard.
              </p>
              <button
...
export default TruckOwnerPasswordSetup;
