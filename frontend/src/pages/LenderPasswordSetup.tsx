...
import { CheckCircle2, Circle, Banknote, ArrowRight } from 'lucide-react';
...
const LenderPasswordSetup = () => {
  ...
  const onSubmit = async (data: PasswordSetupFormData) => {
    ...
    try {
      setIsLoading(true);
      await authAPI.setupLenderPassword({
        token,
          ...
          <div className="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
            <div className="px-6 pt-6 pb-4 text-center">
              ...
              <p className="text-sm text-gray-600 mb-6">
                Your lender account has been activated. You can now log in to access your lender dashboard.
              </p>
              <button
        ...
        <div className="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
          ...
          <div className="px-6 pt-6 pb-4">
            ...
            <p className="text-sm text-gray-600 text-center">
              Welcome to UrutiX! Your lender account has been created. Please set a secure password to get started.
            </p>
          </div>
...
export default LenderPasswordSetup;
