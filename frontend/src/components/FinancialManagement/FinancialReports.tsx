...
const FinancialReports: React.FC = () => {
  ...
  const renderProfitLossReport = (data: ProfitLossData) => (
    <div className="space-y-6">
      <div className="bg-white dark:bg-slate-900 rounded-lg shadow p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="text-center p-4 bg-green-50 rounded-lg">
            <p className="text-sm text-gray-600 dark:text-slate-300">Trip Revenue</p>
            <p className="text-2xl font-bold text-green-600">{formatCurrency(data.revenue.tripRevenue)}</p>
          </div>
          <div className="text-center p-4 bg-blue-50 rounded-lg">
            <p className="text-sm text-gray-600 dark:text-slate-300">Other Revenue</p>
      ...
      <div className="bg-white dark:bg-slate-900 rounded-lg shadow p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <div className="text-center p-4 bg-red-50 rounded-lg">
            <p className="text-sm text-gray-600 dark:text-slate-300">Fuel</p>
            <p className="text-xl font-bold text-red-600">{formatCurrency(data.expenses.fuel)}</p>
          </div>
          <div className="text-center p-4 bg-orange-50 rounded-lg">
            <p className="text-sm text-gray-600 dark:text-slate-300">Maintenance</p>
            <p className="text-xl font-bold text-orange-600">{formatCurrency(data.expenses.maintenance)}</p>
          </div>
          <div className="text-center p-4 bg-yellow-50 rounded-lg">
            <p className="text-sm text-gray-600 dark:text-slate-300">Driver</p>
      ...
      <div className="bg-white dark:bg-slate-900 rounded-lg shadow p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="text-center p-4 bg-blue-50 rounded-lg">
            <p className="text-sm text-gray-600 dark:text-slate-300">Gross Profit</p>
            <p className="text-2xl font-bold text-blue-600">{formatCurrency(data.grossProfit)}</p>
          </div>
          <div className="text-center p-4 bg-green-100 rounded-lg">
            <p className="text-sm text-gray-600 dark:text-slate-300">Net Profit</p>
            <p className="text-2xl font-bold text-green-700">{formatCurrency(data.netProfit)}</p>
          </div>
          <div className="text-center p-4 bg-indigo-50 rounded-lg">
            <p className="text-sm text-gray-600 dark:text-slate-300">Profit Margin</p>
  ...
  const renderCashFlowReport = (data: CashFlowData) => (
    <div className="space-y-6">
      <div className="bg-white dark:bg-slate-900 rounded-lg shadow p-6">
        <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Operating Activities</h3>
        <div className="space-y-3">
          <div className="flex justify-between items-center">
            <span className="text-gray-600 dark:text-slate-300">Net Income</span>
            <span className="font-semibold">{formatCurrency(data.operatingActivities.netIncome)}</span>
          </div>
          <div className="flex justify-between items-center">
            <span className="text-gray-600 dark:text-slate-300">Depreciation</span>
            <span className="font-semibold">{formatCurrency(data.operatingActivities.depreciation)}</span>
          </div>
          <div className="flex justify-between items-center">
            <span className="text-gray-600 dark:text-slate-300">Changes in Working Capital</span>
          ...
          <div className="flex justify-between items-center pt-2 border-t border-gray-200 dark:border-slate-700">
            <span className="font-semibold text-gray-900 dark:text-white">Net Operating Cash Flow</span>
      ...
      <div className="bg-white dark:bg-slate-900 rounded-lg shadow p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <h4 className="font-medium text-gray-900 dark:text-white mb-3">Cash Flow Chart</h4>
          ...
          <div className="space-y-3">
            <div className="flex justify-between items-center">
              <span className="text-gray-600 dark:text-slate-300">Beginning Cash</span>
              <span className="font-semibold">{formatCurrency(data.beginningCash)}</span>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-gray-600 dark:text-slate-300">Net Cash Flow</span>
              <span className={`font-semibold ${data.netCashFlow >= 0 ? 'text-green-600' : 'text-red-600'}`}>
                {formatCurrency(data.netCashFlow)}
              </span>
            </div>
            <div className="flex justify-between items-center pt-2 border-t border-gray-200 dark:border-slate-700">
              <span className="font-semibold text-gray-900 dark:text-white">Ending Cash</span>
  ...
  const renderTaxSummaryReport = (data: any) => (
    <div className="space-y-6">
      <div className="bg-white dark:bg-slate-900 rounded-lg shadow p-6">
        <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Tax Deductible Summary</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="space-y-4">
            <div className="text-center p-6 bg-green-50 rounded-lg">
              <p className="text-sm text-gray-600 dark:text-slate-300">Tax Deductible Expenses</p>
            ...
            <div className="text-center p-6 bg-red-50 rounded-lg">
              <p className="text-sm text-gray-600 dark:text-slate-300">Non-Deductible Expenses</p>
          ...
          <div>
            <h4 className="font-medium text-gray-900 dark:text-white mb-3">Deduction Breakdown</h4>
            <ResponsiveContainer width="100%" height={200}>
              <PieChart>
                <Pie
                  data={[
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-slate-950 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 dark:text-slate-300 mt-2">Generate and view comprehensive financial reports for your trucking business</p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
            {reportTypes.map((type) => (
              <button
                ...
                className="p-4 bg-white dark:bg-slate-900 rounded-lg shadow hover:shadow-md transition-shadow text-center"
              >
        ...
        <div className="bg-white dark:bg-slate-900 rounded-lg shadow p-6 mb-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-slate-300 mb-2">Period</label>
              <select
        ...
        <div className="bg-white dark:bg-slate-900 rounded-lg shadow overflow-hidden">
          ...
          <div className="divide-y divide-gray-200">
            {filteredReports.map((report) => {
              ...
              return (
                <div key={report.id} className="p-6 hover:bg-gray-50 dark:hover:bg-slate-800">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <button className="text-gray-600 dark:text-slate-300 hover:text-gray-900 dark:hover:text-white">
      ...
      {showReportViewer && selectedReport && (
        <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
          <div className="relative top-20 mx-auto p-5 border w-11/12 max-w-6xl shadow-lg rounded-md bg-white dark:bg-slate-900">
            ...
            <div className="mb-4 p-4 bg-gray-50 dark:bg-slate-800/50 rounded-lg">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                <div>
                  <span className="font-medium text-gray-700 dark:text-slate-300">Period:</span> {selectedReport.period}
                </div>
                <div>
                  <span className="font-medium text-gray-700 dark:text-slate-300">Date Range:</span> {formatDate(selectedReport.startDate)} - {formatDate(selectedReport.endDate)}
                </div>
                <div>
                  <span className="font-medium text-gray-700 dark:text-slate-300">Generated:</span> {formatDate(selectedReport.generatedAt)}
                </div>
              </div>
            </div>
