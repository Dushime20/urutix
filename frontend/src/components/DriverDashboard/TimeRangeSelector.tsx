...
export const TimeRangeSelector: React.FC<TimeRangeSelectorProps> = ({
  ...
  return (
    <div className={cn("flex items-center gap-3 overflow-hidden", className)}>
      ...
      <div className="flex items-center gap-1 bg-white/50 backdrop-blur-md rounded-2xl border border-slate-100 dark:border-slate-800 p-1 shadow-sm overflow-x-auto no-scrollbar scroll-smooth">
        {ranges.map((range) => (
          <motion.button
            key={range.value}
            ...
            className={cn(
               ...
               value === range.value
                ...
                : 'text-slate-400 hover:text-[#345E85] hover:bg-white dark:bg-slate-900'
            )}
          >
