...
export const FuelManagement: React.FC<FuelManagementProps> = ({ driverId }) => {
  ...
  const createLogMutation = useMutation({
    ...
    onSuccess: () => {
      toast.success(t('Fuel log recorded successfully!'));
    ...
    onError: () => {
      toast.error(t('Failed to record fuel log'));
    }
  });
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    if (!formData.truckId) {
      toast.error(t('Please specify truck ID'));
      return;
    }
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        ...
        <div className="flex gap-4">
           <button 
              onClick={() => {
                if (!driverProfile?.currentTruckId) {
                  toast.error(t('You must have an assigned truck to record fuel logs'));
                  return;
                }
        ...
        >
            ...
            <div className="relative z-10">
                <div className="flex items-center gap-3 mb-6">
                    ...
                    <div>
                        <h3 className="text-[9px] font-black text-[#345E85] uppercase tracking-[0.3em] mb-0.5"><TranslatedText text="AI Fuel Advisor" /></h3>
                        <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest leading-none"><TranslatedText text="Efficiency Projection" /></p>
                    </div>
                </div>
                ...
                <div className="space-y-4">
                    ...
                    <button className="flex items-center justify-between w-full p-5 bg-[#345E85] text-white rounded-2xl group hover:bg-slate-900 transition-all shadow-lg shadow-blue-900/10">
                        <div className="text-left">
                            <p className="text-[8px] font-black text-blue-100 uppercase tracking-widest mb-0.5"><TranslatedText text="Interactive Coaching" /></p>
                            <p className="text-[10px] font-black uppercase tracking-tight"><TranslatedText text={'Unlock "Green Driving" Bonus (+' + formatCurrencyFull(50) + ')'} /></p>
                        </div>
        ...
        >
            <div className="flex items-center justify-between mb-8">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <p className="text-[9px] font-black text-slate-400 uppercase tracking-widest leading-none mb-0.5"><TranslatedText text="Sustainability" /></p>
                        <h3 className="text-lg font-black text-[#0f172a] uppercase tracking-tight"><TranslatedText text="Eco-Driving Impact" /></h3>
                    </div>
                </div>
                <div className="text-right">
                    <span className="px-3 py-1 bg-blue-50 text-[#345E85] text-[8px] font-black uppercase tracking-widest rounded-lg border border-blue-100">
                        <TranslatedText text="Rank: Silver" />
                    </span>
                </div>
            </div>
            ...
            <div className="space-y-3 pt-6 border-t border-slate-100">
                 ...
                 <p className="text-[8px] font-bold text-slate-400 uppercase italic opacity-70 px-1"><TranslatedText text='Complete 3 more "Green Missions" to unlock Gold Tier rewards' /></p>
            </div>
        </motion.div>
      </div>
          ...
          <div className="fixed inset-0 z-[300] flex items-center justify-center p-4 sm:p-6">
            ...
            >
              <div className="bg-[#345E85] p-6 md:p-10 text-white shrink-0">
                ...
                <p className="text-blue-100/70 text-xs md:text-sm font-medium mt-1"><TranslatedText text="Submit your fuel receipt data for verification" /></p>
              </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6 md:space-y-8">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8">
                    <div className="space-y-2">
                      <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest px-1"><TranslatedText text="Current Assigned Truck" /></label>
                    ...
                    <div className="space-y-2">
                      <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest px-1"><TranslatedText text="Fuel Date" /></label>
                      <div className="relative">
                    ...
                    <div className="space-y-2">
                      <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest px-1"><TranslatedText text="Volume (Gallons)" /></label>
                      <div className="relative">
                    ...
                    <div className="space-y-2">
                      <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest px-1"><TranslatedText text="Price Per Gallon" /></label>
                      <div className="relative">
                    ...
                    <div className="space-y-2 md:col-span-2">
                      <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest px-1"><TranslatedText text="Purchase Location" /></label>
                      <div className="relative">
                    ...
                    <div className="space-y-2">
                      <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest px-1"><TranslatedText text="Payment Method" /></label>
                      <div className="relative">
                        ...
                        >
                          ...
                          <option value="FUEL_CARD">{t('Fuel Card')}</option>
                          <option value="CREDIT_CARD">{t('Credit Card')}</option>
                          <option value="ADVANCE">{t('From Advance')}</option>
                        </select>
                      </div>
                    </div>
                    ...
                    <div className="space-y-4 md:col-span-2 pt-4">
                      <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest px-1"><TranslatedText text="Verification Documents" /></label>
                        ...
                        <div className="relative">
                          ...
                          >
                            ...
                            <span className={`text-[9px] font-black uppercase tracking-widest text-center truncate max-w-full px-2 ${
                              ...
                              {formData.receiptFile ? formData.receiptFile.name : t('Upload Fuel Receipt')}
                            </span>
                          </label>
                        </div>
                        ...
                        <div className="relative">
                          ...
                          >
                            ...
                            <span className={`text-[9px] font-black uppercase tracking-widest text-center truncate max-w-full px-2 ${
                              ...
                              {formData.odometerVerificationFile ? formData.odometerVerificationFile.name : t('Odometer Reading Photo')}
                            </span>
                          </label>
                        </div>
                      </div>
                      <p className="text-[10px] font-medium text-slate-400 italic px-1">
                        <TranslatedText text="* High-quality photos are required for verification to avoid flagging." />
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 pt-6 border-t border-slate-100">
                    ...
                    >
                      {createLogMutation.isPending ? t('Recording...') : t('Submit Log')}
                    </button>
                  </div>
                </form>
              </div>
        ...
        <div className="xl:col-span-2 space-y-8">
          <section>
            <div className="flex items-center justify-between mb-8 px-2">
              <div className="flex items-center gap-3">
                <h3 className="text-xs font-black text-slate-400 uppercase tracking-[0.2em]"><TranslatedText text="Fuel Purchase History" /></h3>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 items-center">
                      <div className="col-span-1">
                        <p className="text-[8px] font-black text-slate-400 uppercase tracking-widest mb-1.5 flex items-center gap-1.5">
                          <Calendar size={10} />
                          <TranslatedText text="Purchase Date" />
                        </p>
                      ...
                      <div className="col-span-1">
                        ...
                        <p className="text-[10px] font-bold text-slate-400 mt-1"><TranslatedText text="Odo:" /> {log.odometer?.toLocaleString() || t('N/A')} km</p>
                      </div>
