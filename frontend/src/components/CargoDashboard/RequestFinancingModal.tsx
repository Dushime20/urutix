...
export const RequestFinancingModal: React.FC<RequestFinancingModalProps> = ({
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-[10000]" onClick={onClose}>
            <div
                className="bg-white rounded-lg shadow-xl max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto pb-24 lg:pb-8"
            ...
            >
                ...
                <div className="p-6">
                    ...
                    <div className="mb-6 p-4 bg-primary-50 border border-primary-200 rounded-lg">
                        <h3 className="text-sm font-semibold text-primary-900 mb-2">Cargo Details</h3>
                        <div className="space-y-1 text-sm">
                            <p className="text-primary-800"><strong>Title:</strong> {cargo.title}</p>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <select
                                    ...
                                    className="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent appearance-none"
                                >
