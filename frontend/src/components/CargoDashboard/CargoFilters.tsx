        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4">
          ...
          {search !== undefined && setSearch && (
            <div className="relative w-full sm:min-w-[220px] sm:flex-1">
              ...
              <input
                type="search"
                className="w-full rounded-lg sm:rounded-xl border border-slate-200 bg-white/80 py-2.5 sm:py-2.5 pl-9 sm:pl-10 pr-3 sm:pr-4 text-sm text-slate-700 shadow-inner transition focus:border-primary-500 focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary-100 touch-manipulation min-h-[44px] sm:min-h-0"
          ...
          <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 w-full sm:w-auto">
            ...
            <div className="flex-1 sm:flex-initial">
              <FilterSelect
                ...
                icon={<Box className="text-primary-500 w-4 h-4" />}
              />
            </div>
          </div>
          ...
          <button
            ...
            className="inline-flex items-center justify-center gap-2 rounded-lg sm:rounded-xl border border-transparent bg-primary-600 px-3 sm:px-4 py-2.5 sm:py-2 text-xs sm:text-sm font-semibold text-white shadow-lg shadow-primary-700/10 transition hover:scale-[1.01] hover:bg-primary-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary-400 focus-visible:ring-offset-2 touch-manipulation min-h-[44px] sm:min-h-0 w-full sm:w-auto"
