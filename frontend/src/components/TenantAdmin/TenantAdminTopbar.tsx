      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-3">
          ...
          <div className="flex items-center space-x-2">
            ...
            <h1 className="text-xl font-semibold text-gray-900">Tenant Administration</h1>
          </div>
        </div>
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="hidden sm:flex items-center space-x-2 px-3 py-2 bg-primary-50 rounded-lg">
            ...
            <div className="text-sm">
              <p className="text-gray-600">Managing</p>
              <p className="font-medium text-primary-900 truncate max-w-32">
