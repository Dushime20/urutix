...
const CargoDetailsForm: React.FC<CargoDetailsFormProps> = ({ onSubmit, loading, error }) => {
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <label className="flex items-center p-3 border rounded-md cursor-pointer hover:bg-gray-50">
            ...
            />
            <div>
              <div className="font-medium">Insurance Required</div>
              <div className="text-sm text-gray-500">Additional cargo insurance coverage</div>
            </div>
          </label>
          ...
          <label className="flex items-center p-3 border rounded-md cursor-pointer hover:bg-gray-50">
            ...
            <div>
              ...
              <div className="text-sm text-gray-500">Requires special handling permits</div>
            </div>
          </label>
          ...
          <label className="flex items-center p-3 border rounded-md cursor-pointer hover:bg-gray-50">
            ...
            />
            <div>
              <div className="font-medium">Fragile Items</div>
              <div className="text-sm text-gray-500">Requires careful handling</div>
            </div>
          </label>
          ...
          <label className="flex items-center p-3 border rounded-md cursor-pointer hover:bg-gray-50">
            ...
            <div>
              <div className="font-medium">
                <FaSnowflake className="inline mr-1 text-blue-500" />
                Refrigerated
              </div>
              <div className="text-sm text-gray-500">Temperature-controlled transport</div>
            </div>
          </label>
        </div>
      </div>
  ...
  const renderReviewTab = () => (
    <div className="space-y-6">
      <h3 className="text-lg font-medium text-gray-900 mb-4">Review Cargo Details</h3>
