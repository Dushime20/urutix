                                        ...
                                        {selectedPartner.recentTransactions && selectedPartner.recentTransactions.length > 0 ? (
                                            <div className="space-y-3">
                                                {selectedPartner.recentTransactions.map((tx) => (
                                                    <div key={tx.id} className="group bg-slate-50 dark:bg-slate-800/30 hover:bg-white dark:hover:bg-slate-800 border border-transparent hover:border-gray-100 dark:hover:border-slate-700 rounded-2xl p-4 transition-all duration-200">
