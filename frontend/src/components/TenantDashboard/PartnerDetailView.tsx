        ...
        <div className="bg-[#F9FAFB] dark:bg-slate-900 rounded-[32px] border border-slate-200 dark:border-slate-800 shadow-2xl overflow-hidden flex flex-col h-[90vh] md:h-[80vh] w-full max-w-5xl text-[#1F2937] dark:text-slate-100 antialiased">
            ...
            <div className="px-6 md:px-10 py-6 md:py-8 bg-white dark:bg-slate-950/20 border-b border-slate-100 dark:border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-6 sm:gap-0">
                <div className="flex items-center gap-4 md:gap-6 w-full sm:w-auto">
                    <div className="w-12 h-12 md:w-14 md:h-14 bg-indigo-600 rounded-2xl flex items-center justify-center shadow-lg shadow-indigo-100 dark:shadow-none flex-shrink-0">
            ...
            <div className="px-6 md:px-10 bg-white dark:bg-slate-950/40 border-b border-slate-100 dark:border-slate-800 flex gap-6 md:gap-8 overflow-x-auto no-scrollbar">
                {tabs.map((tab) => (
                    <button
                        ...
                        className={`py-4 md:py-5 text-[10px] md:text-[11px] font-black uppercase tracking-widest transition-all relative whitespace-nowrap italic ${activeTab === tab.id ? 'text-indigo-600 dark:text-indigo-400' : 'text-slate-400 dark:text-slate-500 hover:text-slate-600 dark:hover:text-slate-300'
                            }`}
                    >
                    ...
                    {activeTab === 'overview' && (
                        ...
                        >
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                                ...
                                <div className="bg-indigo-600 p-6 md:p-8 rounded-[40px] text-white shadow-xl shadow-indigo-100 dark:shadow-none relative overflow-hidden group">
                                                    ...
                                                    {[
                                                        ...
                                                        <button
                                                            ...
                                                            className={`p-4 rounded-[20px] border transition-all flex flex-col items-start gap-1 group/status ${
                                                                partner.status === s.id 
                                                                    ? 'bg-white text-indigo-600 border-white shadow-xl scale-[1.02]' 
                                                        ...
                                                        >
                                                            ...
                                                            <span className={`text-[7px] font-black uppercase tracking-widest opacity-60 group-hover/status:opacity-100 ${partner.status === s.id ? 'text-indigo-400' : 'text-white'}`}>
                                                               {s.desc}
                                                            </span>
                                                        </button>
                                                    ))}
                     ...
                     {activeTab === 'fleet' && (
                        ...
                        >
                            <div className="bg-white dark:bg-slate-800/50 p-6 md:p-10 rounded-[40px] border border-slate-100 dark:border-slate-800 shadow-sm text-center py-20 md:py-28">
                                <div className="w-20 h-20 md:w-24 md:h-24 bg-indigo-50 dark:bg-indigo-900/20 rounded-full flex items-center justify-center mx-auto mb-6 md:mb-10 shadow-lg shadow-indigo-100 dark:shadow-none">
                                    <TrendingUp className="w-10 h-10 md:w-12 md:h-12 text-indigo-600 dark:text-indigo-400" />
                                </div>
                                ...
                                <button className="bg-indigo-600 text-white px-8 md:px-12 py-3.5 md:py-4 rounded-2xl text-[10px] font-black uppercase tracking-widest shadow-xl shadow-indigo-100 dark:shadow-none hover:bg-indigo-700 active:scale-95 transition-all"><TranslatedText text="View Detailed Report" /></button>
                            </div>
                        </motion.div>
                    )}
